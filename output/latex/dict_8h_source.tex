\hypertarget{dict_8h_source}{}\doxysection{dict.\+h}
\label{dict_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/dict.h@{AseSprite/aseprite/third\_party/curl/lib/dict.h}}
...
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#ifndef\ CURL\_DISABLE\_DICT}}
\DoxyCodeLine{00026\ \textcolor{keyword}{extern}\ \textcolor{keyword}{const}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{struct_curl__handler}{Curl\_handler}}\ Curl\_handler\_dict;}
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_DICT\_H\ */}\textcolor{preprocessor}{}}
