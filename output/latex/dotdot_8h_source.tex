\hypertarget{dotdot_8h_source}{}\doxysection{dotdot.\+h}
\label{dotdot_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/dotdot.h@{AseSprite/aseprite/third\_party/curl/lib/dotdot.h}}

\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{preprocessor}{\#ifndef\ HEADER\_CURL\_DOTDOT\_H}}
\DoxyCodeLine{00002\ \textcolor{preprocessor}{\#define\ HEADER\_CURL\_DOTDOT\_H}}
...
\DoxyCodeLine{00024\ \textcolor{keywordtype}{char}\ *Curl\_dedotdotify(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\mbox{\hyperlink{structinput}{input}});}
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_DOTDOT\_H\ */}\textcolor{preprocessor}{}}
