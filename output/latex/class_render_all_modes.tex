\hypertarget{class_render_all_modes}{}\doxysection{Render\+All\+Modes\texorpdfstring{$<$}{<} T \texorpdfstring{$>$}{>} Class Template Reference}
\label{class_render_all_modes}\index{RenderAllModes$<$ T $>$@{RenderAllModes$<$ T $>$}}
Inheritance diagram for Render\+All\+Modes\texorpdfstring{$<$}{<} T \texorpdfstring{$>$}{>}\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.000000cm]{class_render_all_modes}
\end{center}
\end{figure}
...
\item 
Ase\+Sprite/aseprite/src/render/render\+\_\+tests.\+cpp\end{DoxyCompactItemize}
