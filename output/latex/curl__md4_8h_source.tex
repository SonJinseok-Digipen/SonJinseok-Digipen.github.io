\hypertarget{curl__md4_8h_source}{}\doxysection{curl\+\_\+md4.\+h}
\label{curl__md4_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/curl\_md4.h@{AseSprite/aseprite/third\_party/curl/lib/curl\_md4.h}}
...
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#define\ MD4\_DIGEST\_LENGTH\ 16}}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{keywordtype}{void}\ Curl\_md4it(\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *output,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *\mbox{\hyperlink{structinput}{input}},}
\DoxyCodeLine{00032\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{size\_t}\ len);}
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ !defined(CURL\_DISABLE\_CRYPTO\_AUTH)\ */}\textcolor{preprocessor}{}}
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_MD4\_H\ */}\textcolor{preprocessor}{}}
