\hypertarget{curl__get__line_8h_source}{}\doxysection{curl\+\_\+get\+\_\+line.\+h}
\label{curl__get__line_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/curl\_get\_line.h@{AseSprite/aseprite/third\_party/curl/lib/curl\_get\_line.h}}
...
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{comment}{/*\ get\_line()\ makes\ sure\ to\ only\ return\ complete\ whole\ lines\ that\ fit\ in\ 'len'}}
\DoxyCodeLine{00026\ \textcolor{comment}{\ *\ bytes\ and\ end\ with\ a\ newline.\ */}}
\DoxyCodeLine{00027\ \textcolor{keywordtype}{char}\ *Curl\_get\_line(\textcolor{keywordtype}{char}\ *\mbox{\hyperlink{structbuf}{buf}},\ \textcolor{keywordtype}{int}\ len,\ FILE\ *\mbox{\hyperlink{structinput}{input}});}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_GET\_LINE\_H\ */}\textcolor{preprocessor}{}}
