\hypertarget{archive__xxhash_8h_source}{}\doxysection{archive\+\_\+xxhash.\+h}
\label{archive__xxhash_8h_source}\index{AseSprite/aseprite/third\_party/libarchive/libarchive/archive\_xxhash.h@{AseSprite/aseprite/third\_party/libarchive/libarchive/archive\_xxhash.h}}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#ifndef\ ARCHIVE\_XXHASH\_H\_INCLUDED}}
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#define\ ARCHIVE\_XXHASH\_H\_INCLUDED}}
\DoxyCodeLine{00029\ }
...
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \textcolor{keyword}{typedef}\ \textcolor{keyword}{enum}\ \{\ XXH\_OK=0,\ XXH\_ERROR\ \}\ XXH\_errorcode;}
\DoxyCodeLine{00036\ }
\DoxyCodeLine{00037\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structarchive__xxhash}{archive\_xxhash}}\ \{}
\DoxyCodeLine{00038\ \ \ \ \ \textcolor{keywordtype}{unsigned}\ int\ \ (*XXH32)(\textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ \mbox{\hyperlink{structinput}{input}},\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ len,}
\DoxyCodeLine{00039\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ seed);}
\DoxyCodeLine{00040\ \ \ \ \ \textcolor{keywordtype}{void}*\ \ \ \ \ \ \ \ \ (*XXH32\_init)(\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ seed);}
\DoxyCodeLine{00041\ \ \ \ \ XXH\_errorcode\ (*XXH32\_update)(\textcolor{keywordtype}{void}*\ \mbox{\hyperlink{structstate}{state}},\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ \mbox{\hyperlink{structinput}{input}},}
\DoxyCodeLine{00042\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ len);}
\DoxyCodeLine{00043\ \ \ \ \ \textcolor{keywordtype}{unsigned}\ int\ \ (*XXH32\_digest)(\textcolor{keywordtype}{void}*\ \mbox{\hyperlink{structstate}{state}});}
\DoxyCodeLine{00044\ \};}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00046\ \textcolor{keyword}{extern}\ \textcolor{keyword}{const}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structarchive__xxhash}{archive\_xxhash}}\ \_\_archive\_xxhash;}
\DoxyCodeLine{00047\ }
