\hypertarget{tool__writeout__json_8h_source}{}\doxysection{tool\+\_\+writeout\+\_\+json.\+h}
\label{tool__writeout__json_8h_source}\index{AseSprite/aseprite/third\_party/curl/src/tool\_writeout\_json.h@{AseSprite/aseprite/third\_party/curl/src/tool\_writeout\_json.h}}
...
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#include\ "{}tool\_writeout.h"{}}}
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{keywordtype}{void}\ ourWriteOutJSON(FILE\ *stream,\ \textcolor{keyword}{const}\ \textcolor{keyword}{struct}\ \mbox{\hyperlink{structwriteoutvar}{writeoutvar}}\ mappings[],}
\DoxyCodeLine{00028\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{struct}\ \mbox{\hyperlink{structper__transfer}{per\_transfer}}\ *per,\ CURLcode\ per\_result);}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{keywordtype}{void}\ jsonWriteString(FILE\ *stream,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *in);}
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_TOOL\_WRITEOUT\_H\ */}\textcolor{preprocessor}{}}
