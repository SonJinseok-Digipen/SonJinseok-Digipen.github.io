\hypertarget{passphrase_8h_source}{}\doxysection{passphrase.\+h}
\label{passphrase_8h_source}\index{AseSprite/aseprite/third\_party/libarchive/libarchive\_fe/passphrase.h@{AseSprite/aseprite/third\_party/libarchive/libarchive\_fe/passphrase.h}}
...
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#ifndef\ LAFE\_PASSPHRASE\_H}}
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#define\ LAFE\_PASSPHRASE\_H}}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{keywordtype}{char}\ *lafe\_readpassphrase(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *prompt,\ \textcolor{keywordtype}{char}\ *\mbox{\hyperlink{structbuf}{buf}},\ \textcolor{keywordtype}{size\_t}\ bufsiz);}
\DoxyCodeLine{00030\ }
