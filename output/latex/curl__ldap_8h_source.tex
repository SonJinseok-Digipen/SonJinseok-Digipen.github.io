\hypertarget{curl__ldap_8h_source}{}\doxysection{curl\+\_\+ldap.\+h}
\label{curl__ldap_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/curl\_ldap.h@{AseSprite/aseprite/third\_party/curl/lib/curl\_ldap.h}}
...
\DoxyCodeLine{00024\ \textcolor{preprocessor}{\#ifndef\ CURL\_DISABLE\_LDAP}}
\DoxyCodeLine{00025\ \textcolor{keyword}{extern}\ \textcolor{keyword}{const}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{struct_curl__handler}{Curl\_handler}}\ Curl\_handler\_ldap;}
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#if\ !defined(CURL\_DISABLE\_LDAPS)\ \&\&\ \(\backslash\)}}
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\ \ \ \ ((defined(USE\_OPENLDAP)\ \&\&\ defined(USE\_SSL))\ ||\ \(\backslash\)}}
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\ \ \ \ \ (!defined(USE\_OPENLDAP)\ \&\&\ defined(HAVE\_LDAP\_SSL)))}}
\DoxyCodeLine{00030\ \textcolor{keyword}{extern}\ \textcolor{keyword}{const}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{struct_curl__handler}{Curl\_handler}}\ Curl\_handler\_ldaps;}
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_LDAP\_H\ */}\textcolor{preprocessor}{}}
