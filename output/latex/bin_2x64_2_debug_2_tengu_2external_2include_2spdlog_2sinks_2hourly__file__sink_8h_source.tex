\hypertarget{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2hourly__file__sink_8h_source}{}\doxysection{hourly\+\_\+file\+\_\+sink.\+h}
\label{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2hourly__file__sink_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/hourly\_file\_sink.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/hourly\_file\_sink.h}}
...
\DoxyCodeLine{00045\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1hourly__file__sink}{hourly\_file\_sink}}\ final\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink}}<Mutex>}
\DoxyCodeLine{00046\ \{}
...
\DoxyCodeLine{00049\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1hourly__file__sink}{hourly\_file\_sink}}(}
\DoxyCodeLine{00050\ \ \ \ \ \ \ \ \ filename\_t\ base\_filename,\ \textcolor{keywordtype}{bool}\ truncate\ =\ \textcolor{keyword}{false},\ uint16\_t\ max\_files\ =\ 0,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1file__event__handlers}{file\_event\_handlers}}\ \&event\_handlers\ =\ \{\})}
...
\DoxyCodeLine{00070\ \ \ \ \ \{}
\DoxyCodeLine{00071\ \ \ \ \ \ \ \ \ std::lock\_guard<Mutex>\ lock(\mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink<Mutex>::mutex\_}});}
\DoxyCodeLine{00072\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ file\_helper\_.filename();}
\DoxyCodeLine{00073\ \ \ \ \ \}}
\DoxyCodeLine{00074\ }
\DoxyCodeLine{00075\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00076\ \ \ \ \ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&msg)\textcolor{keyword}{\ override}}
...
\DoxyCodeLine{00093\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink<Mutex>::formatter\_}}-\/>format(msg,\ formatted);}
...
\DoxyCodeLine{00112\ }
\DoxyCodeLine{00113\ \ \ \ \ \ \ \ \ filenames\_q\_\ =\ \mbox{\hyperlink{classspdlog_1_1details_1_1circular__q}{details::circular\_q<filename\_t>}}(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(max\_files\_));}
...
\DoxyCodeLine{00168\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ SPDLOG\_THROW(\mbox{\hyperlink{classspdlog_1_1spdlog__ex}{spdlog\_ex}}(\textcolor{stringliteral}{"{}Failed\ removing\ hourly\ file\ "{}}\ +\ filename\_to\_str(old\_filename),\ errno));}
\DoxyCodeLine{00169\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00170\ \ \ \ \ \ \ \ \ \}}
...
\DoxyCodeLine{00176\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1file__helper}{details::file\_helper}}\ file\_helper\_;}
\DoxyCodeLine{00177\ \ \ \ \ \textcolor{keywordtype}{bool}\ truncate\_;}
\DoxyCodeLine{00178\ \ \ \ \ uint16\_t\ max\_files\_;}
\DoxyCodeLine{00179\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1circular__q}{details::circular\_q<filename\_t>}}\ filenames\_q\_;}
\DoxyCodeLine{00180\ \ \ \ \ \textcolor{keywordtype}{bool}\ remove\_init\_file\_;}
\DoxyCodeLine{00181\ \};}
\DoxyCodeLine{00182\ }
\DoxyCodeLine{00183\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1hourly__file__sink}{hourly\_file\_sink\_mt}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1hourly__file__sink}{hourly\_file\_sink<std::mutex>}};}
\DoxyCodeLine{00184\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1hourly__file__sink}{hourly\_file\_sink\_st}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1hourly__file__sink}{hourly\_file\_sink<details::null\_mutex>}};}
\DoxyCodeLine{00185\ }
...
\DoxyCodeLine{00193\ \ \ \ \ uint16\_t\ max\_files\ =\ 0,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1file__event__handlers}{file\_event\_handlers}}\ \&event\_handlers\ =\ \{\})}
\DoxyCodeLine{00194\ \{}
