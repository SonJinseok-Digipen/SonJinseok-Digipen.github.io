\hypertarget{getinfo_8h_source}{}\doxysection{getinfo.\+h}
\label{getinfo_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/getinfo.h@{AseSprite/aseprite/third\_party/curl/lib/getinfo.h}}
...
\DoxyCodeLine{00024\ CURLcode\ Curl\_getinfo(\textcolor{keyword}{struct}\ \mbox{\hyperlink{struct_curl__easy}{Curl\_easy}}\ *\mbox{\hyperlink{structdata}{data}},\ CURLINFO\ info,\ ...);}
\DoxyCodeLine{00025\ CURLcode\ Curl\_initinfo(\textcolor{keyword}{struct}\ \mbox{\hyperlink{struct_curl__easy}{Curl\_easy}}\ *\mbox{\hyperlink{structdata}{data}});}
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_GETINFO\_H\ */}\textcolor{preprocessor}{}}
