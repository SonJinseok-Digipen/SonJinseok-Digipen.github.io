\hypertarget{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2details_2periodic__worker_8h_source}{}\doxysection{periodic\+\_\+worker.\+h}
\label{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2details_2periodic__worker_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/details/periodic\_worker.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/details/periodic\_worker.h}}
...
\DoxyCodeLine{00019\ }
\DoxyCodeLine{00020\ \textcolor{keyword}{class\ }SPDLOG\_API\ \mbox{\hyperlink{classspdlog_1_1details_1_1periodic__worker}{periodic\_worker}}}
\DoxyCodeLine{00021\ \{}
\DoxyCodeLine{00022\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00023\ \ \ \ \ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Rep,\ \textcolor{keyword}{typename}\ Period>}
\DoxyCodeLine{00024\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1periodic__worker}{periodic\_worker}}(\textcolor{keyword}{const}\ std::function<\textcolor{keywordtype}{void}()>\ \&callback\_fun,\ std::chrono::duration<Rep,\ Period>\ interval)}
\DoxyCodeLine{00025\ \ \ \ \ \{}
...
\DoxyCodeLine{00042\ \ \ \ \ \ \ \ \ \});}
\DoxyCodeLine{00043\ \ \ \ \ \}}
\DoxyCodeLine{00044\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1periodic__worker}{periodic\_worker}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classspdlog_1_1details_1_1periodic__worker}{periodic\_worker}}\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00045\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1periodic__worker}{periodic\_worker}}\ \&operator=(\textcolor{keyword}{const}\ \mbox{\hyperlink{classspdlog_1_1details_1_1periodic__worker}{periodic\_worker}}\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00046\ \ \ \ \ \textcolor{comment}{//\ stop\ the\ worker\ thread\ and\ join\ it}}
\DoxyCodeLine{00047\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1periodic__worker}{\string~periodic\_worker}}();}
\DoxyCodeLine{00048\ }
