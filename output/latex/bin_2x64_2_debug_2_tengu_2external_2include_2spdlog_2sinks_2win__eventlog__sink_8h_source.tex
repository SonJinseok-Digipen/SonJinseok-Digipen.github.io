\hypertarget{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2win__eventlog__sink_8h_source}{}\doxysection{win\+\_\+eventlog\+\_\+sink.\+h}
\label{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2win__eventlog__sink_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/win\_eventlog\_sink.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/win\_eventlog\_sink.h}}
...
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00050\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1local__alloc__t}{local\_alloc\_t}}}
\DoxyCodeLine{00051\ \{}
\DoxyCodeLine{00052\ \ \ \ \ HLOCAL\ hlocal\_;}
\DoxyCodeLine{00053\ }
\DoxyCodeLine{00054\ \ \ \ \ SPDLOG\_CONSTEXPR\ \mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1local__alloc__t}{local\_alloc\_t}}()\ SPDLOG\_NOEXCEPT\ :\ hlocal\_(\textcolor{keyword}{nullptr})\ \{\}}
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1local__alloc__t}{local\_alloc\_t}}(\mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1local__alloc__t}{local\_alloc\_t}}\ \textcolor{keyword}{const}\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00057\ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1local__alloc__t}{local\_alloc\_t}}\ \&operator=(\mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1local__alloc__t}{local\_alloc\_t}}\ \textcolor{keyword}{const}\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1local__alloc__t}{\string~local\_alloc\_t}}()\ SPDLOG\_NOEXCEPT}
\DoxyCodeLine{00060\ \ \ \ \ \{}
...
\DoxyCodeLine{00066\ \};}
\DoxyCodeLine{00067\ }
\DoxyCodeLine{00069\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1win32__error}{win32\_error}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classspdlog_1_1spdlog__ex}{spdlog\_ex}}}
\DoxyCodeLine{00070\ \{}
...
\DoxyCodeLine{00092\ \};}
\DoxyCodeLine{00093\ }
\DoxyCodeLine{00095\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1sid__t}{sid\_t}}}
\DoxyCodeLine{00096\ \{}
\DoxyCodeLine{00097\ \ \ \ \ std::vector<char>\ buffer\_;}
\DoxyCodeLine{00098\ }
\DoxyCodeLine{00099\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00100\ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1sid__t}{sid\_t}}()\ \{\}}
\DoxyCodeLine{00101\ }
...
\DoxyCodeLine{00167\ \};}
\DoxyCodeLine{00168\ }
\DoxyCodeLine{00169\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1eventlog}{eventlog}}}
\DoxyCodeLine{00170\ \{}
...
\DoxyCodeLine{00207\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1win__eventlog_1_1win__eventlog__sink}{win\_eventlog\_sink}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink}}<Mutex>}
\DoxyCodeLine{00208\ \{}
\DoxyCodeLine{00209\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00210\ \ \ \ \ HANDLE\ hEventLog\_\{NULL\};}
\DoxyCodeLine{00211\ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1sid__t}{internal::sid\_t}}\ current\_user\_sid\_;}
...
\DoxyCodeLine{00221\ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00222\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ SPDLOG\_THROW(\mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1win32__error}{internal::win32\_error}}(\textcolor{stringliteral}{"{}RegisterEventSource"{}}));}
\DoxyCodeLine{00223\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00224\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00225\ }
...
\DoxyCodeLine{00230\ \ \ \ \ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&msg)\textcolor{keyword}{\ override}}
...
\DoxyCodeLine{00236\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink<Mutex>::formatter\_}}-\/>format(msg,\ formatted);}
...
\DoxyCodeLine{00245\ \ \ \ \ \ \ \ \ \ \ \ \ current\_user\_sid\_.\mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1sid__t_a6b69019a95609aca5fcc5aa8d30ff48a}{as\_sid}}(),\ 1,\ 0,\ \&lp\_wstr,\ \textcolor{keyword}{nullptr}));}
...
\DoxyCodeLine{00249\ \ \ \ \ \ \ \ \ \ \ \ \ current\_user\_sid\_.\mbox{\hyperlink{structspdlog_1_1sinks_1_1win__eventlog_1_1internal_1_1sid__t_a6b69019a95609aca5fcc5aa8d30ff48a}{as\_sid}}(),\ 1,\ 0,\ \&lp\_str,\ \textcolor{keyword}{nullptr}));}
...
\DoxyCodeLine{00261\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1win__eventlog_1_1win__eventlog__sink}{win\_eventlog\_sink}}(std::string\ \textcolor{keyword}{const}\ \&source,\ DWORD\ event\_id\ =\ 1000\ \textcolor{comment}{/*\ according\ to\ mscoree.dll\ */})}
...
\DoxyCodeLine{00274\ \ \ \ \ \}}
\DoxyCodeLine{00275\ }
\DoxyCodeLine{00276\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1win__eventlog_1_1win__eventlog__sink}{\string~win\_eventlog\_sink}}()}
\DoxyCodeLine{00277\ \ \ \ \ \{}
...
\DoxyCodeLine{00284\ }
\DoxyCodeLine{00285\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1win__eventlog_1_1win__eventlog__sink}{win\_eventlog\_sink\_mt}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1win__eventlog_1_1win__eventlog__sink}{win\_eventlog::win\_eventlog\_sink<std::mutex>}};}
\DoxyCodeLine{00286\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1win__eventlog_1_1win__eventlog__sink}{win\_eventlog\_sink\_st}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1win__eventlog_1_1win__eventlog__sink}{win\_eventlog::win\_eventlog\_sink<details::null\_mutex>}};}
\DoxyCodeLine{00287\ }
