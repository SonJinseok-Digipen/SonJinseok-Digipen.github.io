\hypertarget{_tengu_2bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2fmt_2bundled_2ostream_8h_source}{}\doxysection{ostream.\+h}
\label{_tengu_2bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2fmt_2bundled_2ostream_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/fmt/bundled/ostream.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/fmt/bundled/ostream.h}}
...
\DoxyCodeLine{00030\ \textcolor{keyword}{class\ }is\_streamable\ \{}
...
\DoxyCodeLine{00042\ \ \ is\_streamable()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00043\ }
...
\DoxyCodeLine{00050\ \textcolor{keyword}{struct\ }is\_streamable<}
...
\DoxyCodeLine{00066\ \textcolor{keyword}{class\ }file\_access\ \{}
...
\DoxyCodeLine{00071\ \textcolor{keyword}{template}\ \textcolor{keyword}{class\ }file\_access<file\_access\_tag,\ std::filebuf,}
...
\DoxyCodeLine{00075\ \textcolor{keyword}{template}\ \textcolor{keyword}{class\ }file\_access<file\_access\_tag,\ std::\_\_stdoutbuf<char>,}
...
\DoxyCodeLine{00087\ \ \ \textcolor{keywordflow}{if}\ (\textcolor{keyword}{auto}*\ fbuf\ =\ \textcolor{keyword}{dynamic\_cast<}\_\_gnu\_cxx::stdio\_sync\_filebuf<char>*\textcolor{keyword}{>}(rdbuf))}
\DoxyCodeLine{00088\ \ \ \ \ c\_file\ =\ fbuf-\/>file();}
...
\DoxyCodeLine{00133\ \}}
\DoxyCodeLine{00134\ }
\DoxyCodeLine{00135\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>\ \textcolor{keyword}{struct\ }streamed\_view\ \{\ \textcolor{keyword}{const}\ T\&\ \mbox{\hyperlink{classvalue}{value}};\ \};}
\DoxyCodeLine{00136\ }
...
\DoxyCodeLine{00185\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structfallback__formatter}{fallback\_formatter}}<T,\ Char,\ enable\_if\_t<is\_streamable<T,\ Char>::\mbox{\hyperlink{classvalue}{value}}>>}
...
\DoxyCodeLine{00192\ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classbuffer}{buffer}}\ =\ \mbox{\hyperlink{classbasic__memory__buffer}{memory\_buffer}}();}
\DoxyCodeLine{00193\ \ \ detail::vformat\_to(\mbox{\hyperlink{classbuffer}{buffer}},\ format\_str,\ args);}
\DoxyCodeLine{00194\ \ \ detail::write\_buffer(os,\ \mbox{\hyperlink{classbuffer}{buffer}});}
\DoxyCodeLine{00195\ \}}
\DoxyCodeLine{00196\ }
