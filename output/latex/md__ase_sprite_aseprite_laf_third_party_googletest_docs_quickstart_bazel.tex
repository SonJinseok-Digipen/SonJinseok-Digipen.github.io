This tutorial aims to get you up and running with Google\+Test using the Bazel build system. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_bazel_autotoc_md333}{}\doxysection{Prerequisites}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_bazel_autotoc_md333}
...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_bazel_autotoc_md334}{}\doxysection{Set up a Bazel workspace}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_bazel_autotoc_md334}
\mbox{\hyperlink{class_a}{A}} \href{https://docs.bazel.build/versions/main/build-ref.html\#workspace}{\texttt{ Bazel workspace}} is a directory on your filesystem that you use to manage source files for the software you want to build. Each workspace directory has a text file named {\ttfamily WORKSPACE} which may be empty, or may contain references to external dependencies required to build the outputs.
...
Now you\textquotesingle{}re ready to build C++ code that uses Google\+Test.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_bazel_autotoc_md335}{}\doxysection{Create and run a binary}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_bazel_autotoc_md335}
...
==================== \mbox{\hyperlink{class_test}{Test}} output for //:hello\_test:
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_bazel_autotoc_md336}{}\doxysection{Next steps}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_bazel_autotoc_md336}
