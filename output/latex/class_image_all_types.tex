\hypertarget{class_image_all_types}{}\doxysection{Image\+All\+Types\texorpdfstring{$<$}{<} T \texorpdfstring{$>$}{>} Class Template Reference}
\label{class_image_all_types}\index{ImageAllTypes$<$ T $>$@{ImageAllTypes$<$ T $>$}}
Inheritance diagram for Image\+All\+Types\texorpdfstring{$<$}{<} T \texorpdfstring{$>$}{>}\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.000000cm]{class_image_all_types}
\end{center}
\end{figure}
...
\item 
Ase\+Sprite/aseprite/src/doc/image\+\_\+tests.\+cpp\end{DoxyCompactItemize}
