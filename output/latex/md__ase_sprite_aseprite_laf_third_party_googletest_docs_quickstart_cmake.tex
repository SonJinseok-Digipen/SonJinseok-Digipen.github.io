This tutorial aims to get you up and running with Google\+Test using CMake. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point. If your project uses Bazel, see the \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_bazel}{Quickstart for Bazel}} instead.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_cmake_autotoc_md338}{}\doxysection{Prerequisites}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_cmake_autotoc_md338}
To complete this tutorial, you\textquotesingle{}ll need\+:


\begin{DoxyItemize}
\item \mbox{\hyperlink{class_a}{A}} compatible operating system (e.\+g. Linux, mac\+OS, Windows).
\item \mbox{\hyperlink{class_a}{A}} compatible C++ compiler that supports at least C++14.
...
See \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_platforms}{Supported Platforms}} for more information about platforms compatible with Google\+Test.
...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_cmake_autotoc_md339}{}\doxysection{Set up a project}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_cmake_autotoc_md339}
...
For more information about how to create {\ttfamily CMake\+Lists.\+txt} files, see the \href{https://cmake.org/cmake/help/latest/guide/tutorial/index.html}{\texttt{ CMake Tutorial}}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_cmake_autotoc_md340}{}\doxysection{Create and run a binary}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_cmake_autotoc_md340}
...
\mbox{\hyperlink{class_test}{Test}} project .../my\_project/build
    Start 1: HelloTest.BasicAssertions
1/1 \mbox{\hyperlink{class_test}{Test}} \#1: HelloTest.BasicAssertions ........   Passed    0.00 sec

100\% tests passed, 0 tests failed out of 1

Total \mbox{\hyperlink{class_test}{Test}} time (real) =   0.01 sec
\end{DoxyPre}


Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_cmake_autotoc_md341}{}\doxysection{Next steps}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_quickstart_cmake_autotoc_md341}

\begin{DoxyItemize}
\item \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer}{Check out the Primer}} to start learning how to write simple tests.
\item \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_samples}{See the code samples}} for more examples showing how to use a variety of Google\+Test features. 
\end{DoxyItemize}