\hypertarget{lib_2tftp_8h_source}{}\doxysection{tftp.\+h}
\label{lib_2tftp_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/tftp.h@{AseSprite/aseprite/third\_party/curl/lib/tftp.h}}
...
\DoxyCodeLine{00024\ \textcolor{preprocessor}{\#ifndef\ CURL\_DISABLE\_TFTP}}
\DoxyCodeLine{00025\ \textcolor{keyword}{extern}\ \textcolor{keyword}{const}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{struct_curl__handler}{Curl\_handler}}\ Curl\_handler\_tftp;}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_TFTP\_H\ */}\textcolor{preprocessor}{}}
