...
It is been used on big mobile video game titles sending and receiving tons of messages since 2017 (i\+OS and Android). It was tested on mac\+OS, i\+OS, Linux, Android, Windows and Free\+BSD. Note that the Min\+GW compiler is not supported at this point. Two important design goals are simplicity and correctness.

\mbox{\hyperlink{class_a}{A}} bad security bug affecting users compiling with SSL enabled and Open\+SSL as the backend was just fixed in newly released version 11.\+0.\+0. Please upgrade ! (more details in the \mbox{[}\href{https://github.com/machinezone/IXWebSocket/pull/250}{\texttt{ https\+://github.\+com/machinezone/\+IXWeb\+Socket/pull/250}}\mbox{]}(PR).
...
Starting with the 11.\+0.\+8 release, IXWeb\+Socket should be fully C++11 compatible.\hypertarget{md__ase_sprite_aseprite_third_party__i_x_web_socket_docs_index_autotoc_md1733}{}\doxysection{Users}\label{md__ase_sprite_aseprite_third_party__i_x_web_socket_docs_index_autotoc_md1733}
...
\end{DoxyItemize}\hypertarget{md__ase_sprite_aseprite_third_party__i_x_web_socket_docs_index_autotoc_md1734}{}\doxysection{Alternative libraries}\label{md__ase_sprite_aseprite_third_party__i_x_web_socket_docs_index_autotoc_md1734}
...
To check the performance of a websocket library, you can look at the \href{https://github.com/bsergean/autoroute}{\texttt{ autoroute}} project.\hypertarget{md__ase_sprite_aseprite_third_party__i_x_web_socket_docs_index_autotoc_md1735}{}\doxysection{Continuous Integration}\label{md__ase_sprite_aseprite_third_party__i_x_web_socket_docs_index_autotoc_md1735}
\tabulinesep=1mm
