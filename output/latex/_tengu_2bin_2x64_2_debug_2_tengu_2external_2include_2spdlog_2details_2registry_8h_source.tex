\hypertarget{_tengu_2bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2details_2registry_8h_source}{}\doxysection{registry.\+h}
\label{_tengu_2bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2details_2registry_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/details/registry.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/details/registry.h}}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{keyword}{class\ }SPDLOG\_API\ \mbox{\hyperlink{classspdlog_1_1details_1_1registry}{registry}}}
\DoxyCodeLine{00028\ \{}
\DoxyCodeLine{00029\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00030\ \ \ \ \ \textcolor{keyword}{using\ }log\_levels\ =\ std::unordered\_map<std::string,\ level::level\_enum>;}
\DoxyCodeLine{00031\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1registry}{registry}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classspdlog_1_1details_1_1registry}{registry}}\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00032\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1registry}{registry}}\ \&operator=(\textcolor{keyword}{const}\ \mbox{\hyperlink{classspdlog_1_1details_1_1registry}{registry}}\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00033\ }
...
\DoxyCodeLine{00043\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}\ *get\_default\_raw();}
\DoxyCodeLine{00044\ }
...
\DoxyCodeLine{00054\ \ \ \ \ \textcolor{keywordtype}{void}\ set\_formatter(std::unique\_ptr<formatter>\ \mbox{\hyperlink{classspdlog_1_1formatter}{formatter}});}
\DoxyCodeLine{00055\ }
...
\DoxyCodeLine{00091\ }
\DoxyCodeLine{00092\ \ \ \ \ \textcolor{keyword}{static}\ \mbox{\hyperlink{classspdlog_1_1details_1_1registry}{registry}}\ \&instance();}
\DoxyCodeLine{00093\ }
\DoxyCodeLine{00094\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00095\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1registry}{registry}}();}
\DoxyCodeLine{00096\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1registry}{\string~registry}}();}
\DoxyCodeLine{00097\ }
...
\DoxyCodeLine{00100\ \ \ \ \ \textcolor{keywordtype}{bool}\ set\_level\_from\_cfg\_(\mbox{\hyperlink{classspdlog_1_1logger}{logger}}\ *\mbox{\hyperlink{classspdlog_1_1logger}{logger}});}
