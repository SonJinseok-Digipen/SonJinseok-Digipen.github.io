\hypertarget{external_2include_2spdlog_2sinks_2syslog__sink_8h_source}{}\doxysection{syslog\+\_\+sink.\+h}
\label{external_2include_2spdlog_2sinks_2syslog__sink_8h_source}\index{Tengu/external/include/spdlog/sinks/syslog\_sink.h@{Tengu/external/include/spdlog/sinks/syslog\_sink.h}}
...
\DoxyCodeLine{00024\ \ \ \ \ syslog\_sink(std::string\ ident,\ \textcolor{keywordtype}{int}\ syslog\_option,\ \textcolor{keywordtype}{int}\ syslog\_facility,\ \textcolor{keywordtype}{bool}\ enable\_formatting)}
...
\DoxyCodeLine{00037\ \ \ \ \ \}}
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00039\ \ \ \ \ \string~syslog\_sink()\textcolor{keyword}{\ override}}
\DoxyCodeLine{00040\ \textcolor{keyword}{\ \ \ \ }\{}
\DoxyCodeLine{00041\ \ \ \ \ \ \ \ \ ::closelog();}
\DoxyCodeLine{00042\ \ \ \ \ \}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \ \ \ \ syslog\_sink(\textcolor{keyword}{const}\ syslog\_sink\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00045\ \ \ \ \ syslog\_sink\ \&operator=(\textcolor{keyword}{const}\ syslog\_sink\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00046\ }
\DoxyCodeLine{00047\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00048\ \ \ \ \ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ details::log\_msg\ \&msg)\textcolor{keyword}{\ override}}
...
\DoxyCodeLine{00053\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00054\ \ \ \ \ \ \ \ \ \ \ \ \ base\_sink<Mutex>::formatter\_-\/>format(msg,\ formatted);}
...
\DoxyCodeLine{00085\ \ \ \ \ \textcolor{keywordtype}{int}\ syslog\_prio\_from\_level(\textcolor{keyword}{const}\ details::log\_msg\ \&msg)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00089\ \};}
\DoxyCodeLine{00090\ }
\DoxyCodeLine{00091\ \textcolor{keyword}{using\ }syslog\_sink\_mt\ =\ syslog\_sink<std::mutex>;}
\DoxyCodeLine{00092\ \textcolor{keyword}{using\ }syslog\_sink\_st\ =\ syslog\_sink<details::null\_mutex>;}
