\hypertarget{speedcheck_8h_source}{}\doxysection{speedcheck.\+h}
\label{speedcheck_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/speedcheck.h@{AseSprite/aseprite/third\_party/curl/lib/speedcheck.h}}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#include\ "{}timeval.h"{}}}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{keywordtype}{void}\ Curl\_speedinit(\textcolor{keyword}{struct}\ \mbox{\hyperlink{struct_curl__easy}{Curl\_easy}}\ *\mbox{\hyperlink{structdata}{data}});}
\DoxyCodeLine{00030\ CURLcode\ Curl\_speedcheck(\textcolor{keyword}{struct}\ \mbox{\hyperlink{struct_curl__easy}{Curl\_easy}}\ *\mbox{\hyperlink{structdata}{data}},}
\DoxyCodeLine{00031\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{struct}\ \mbox{\hyperlink{structcurltime}{curltime}}\ now);}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_SPEEDCHECK\_H\ */}\textcolor{preprocessor}{}}
