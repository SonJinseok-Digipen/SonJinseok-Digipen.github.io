\hypertarget{tool__parsecfg_8h_source}{}\doxysection{tool\+\_\+parsecfg.\+h}
\label{tool__parsecfg_8h_source}\index{AseSprite/aseprite/third\_party/curl/src/tool\_parsecfg.h@{AseSprite/aseprite/third\_party/curl/src/tool\_parsecfg.h}}
...
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00026\ \textcolor{keywordtype}{int}\ parseconfig(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *filename,\ \textcolor{keyword}{struct}\ \mbox{\hyperlink{struct_global_config}{GlobalConfig}}\ *\mbox{\hyperlink{structconfig__s}{config}});}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_TOOL\_PARSECFG\_H\ */}\textcolor{preprocessor}{}}
