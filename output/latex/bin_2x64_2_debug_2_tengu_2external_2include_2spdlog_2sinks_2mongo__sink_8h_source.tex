\hypertarget{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2mongo__sink_8h_source}{}\doxysection{mongo\+\_\+sink.\+h}
\label{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2mongo__sink_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/mongo\_sink.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/mongo\_sink.h}}
...
\DoxyCodeLine{00029\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1mongo__sink}{mongo\_sink}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink}}<Mutex>}
\DoxyCodeLine{00030\ \{}
\DoxyCodeLine{00031\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00032\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1mongo__sink}{mongo\_sink}}(\textcolor{keyword}{const}\ std::string\ \&db\_name,\ \textcolor{keyword}{const}\ std::string\ \&collection\_name,\ \textcolor{keyword}{const}\ std::string\ \&uri\ =\ \textcolor{stringliteral}{"{}mongodb://localhost:27017"{}})}
\DoxyCodeLine{00033\ \ \ \ \ \textcolor{keyword}{try}\ :\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1mongo__sink}{mongo\_sink}}(std::make\_shared<mongocxx::instance>(),\ db\_name,\ collection\_name,\ uri)}
\DoxyCodeLine{00034\ \ \ \ \ \{\}}
...
\DoxyCodeLine{00038\ \ \ \ \ \}}
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1mongo__sink}{mongo\_sink}}(std::shared\_ptr<mongocxx::instance>\ instance,\ \textcolor{keyword}{const}\ std::string\ \&db\_name,\ \textcolor{keyword}{const}\ std::string\ \&collection\_name,}
...
\DoxyCodeLine{00054\ \ \ \ \ \}}
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1mongo__sink}{\string~mongo\_sink}}()}
\DoxyCodeLine{00057\ \ \ \ \ \{}
\DoxyCodeLine{00058\ \ \ \ \ \ \ \ \ flush\_();}
\DoxyCodeLine{00059\ \ \ \ \ \}}
\DoxyCodeLine{00060\ }
\DoxyCodeLine{00061\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00062\ \ \ \ \ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&msg)\textcolor{keyword}{\ override}}
...
\DoxyCodeLine{00088\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1mongo__sink}{mongo\_sink\_mt}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1mongo__sink}{mongo\_sink<std::mutex>}};}
\DoxyCodeLine{00089\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1mongo__sink}{mongo\_sink\_st}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1mongo__sink}{mongo\_sink<spdlog::details::null\_mutex>}};}
\DoxyCodeLine{00090\ }
