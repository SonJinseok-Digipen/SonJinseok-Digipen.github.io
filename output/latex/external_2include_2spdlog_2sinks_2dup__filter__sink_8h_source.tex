\hypertarget{external_2include_2spdlog_2sinks_2dup__filter__sink_8h_source}{}\doxysection{dup\+\_\+filter\+\_\+sink.\+h}
\label{external_2include_2spdlog_2sinks_2dup__filter__sink_8h_source}\index{Tengu/external/include/spdlog/sinks/dup\_filter\_sink.h@{Tengu/external/include/spdlog/sinks/dup\_filter\_sink.h}}
...
\DoxyCodeLine{00044\ \ \ \ \ \textcolor{keyword}{explicit}\ dup\_filter\_sink(std::chrono::duration<Rep,\ Period>\ max\_skip\_duration,\ level::level\_enum\ notification\_level\ =\ level::info)}
...
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \ \ \ \ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ details::log\_msg\ \&msg)\textcolor{keyword}{\ override}}
...
\DoxyCodeLine{00071\ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00072\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ details::log\_msg\ skipped\_msg\{msg.source,\ msg.logger\_name,\ log\_level\_,\ string\_view\_t\{\mbox{\hyperlink{structbuf}{buf}},\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(msg\_size)\}\};}
\DoxyCodeLine{00073\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ dist\_sink<Mutex>::sink\_it\_(skipped\_msg);}
\DoxyCodeLine{00074\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00075\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00076\ }
\DoxyCodeLine{00077\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ log\ current\ message}}
\DoxyCodeLine{00078\ \ \ \ \ \ \ \ \ dist\_sink<Mutex>::sink\_it\_(msg);}
...
\DoxyCodeLine{00085\ \ \ \ \ \textcolor{keywordtype}{bool}\ filter\_(\textcolor{keyword}{const}\ details::log\_msg\ \&msg)}
\DoxyCodeLine{00086\ \ \ \ \ \{}
...
\DoxyCodeLine{00090\ \};}
\DoxyCodeLine{00091\ }
\DoxyCodeLine{00092\ \textcolor{keyword}{using\ }dup\_filter\_sink\_mt\ =\ dup\_filter\_sink<std::mutex>;}
\DoxyCodeLine{00093\ \textcolor{keyword}{using\ }dup\_filter\_sink\_st\ =\ dup\_filter\_sink<details::null\_mutex>;}
\DoxyCodeLine{00094\ }
