\hypertarget{inet__ntop_8h_source}{}\doxysection{inet\+\_\+ntop.\+h}
\label{inet__ntop_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/inet\_ntop.h@{AseSprite/aseprite/third\_party/curl/lib/inet\_ntop.h}}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{keywordtype}{char}\ *Curl\_inet\_ntop(\textcolor{keywordtype}{int}\ af,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{void}\ *addr,\ \textcolor{keywordtype}{char}\ *\mbox{\hyperlink{structbuf}{buf}},\ \textcolor{keywordtype}{size\_t}\ size);}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#ifdef\ HAVE\_INET\_NTOP}}
...
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#define\ Curl\_inet\_ntop(af,addr,buf,size)\ \(\backslash\)}}
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\ \ \ \ \ \ \ \ inet\_ntop(af,\ addr,\ buf,\ (curl\_socklen\_t)size)}}
\DoxyCodeLine{00035\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00036\ }
\DoxyCodeLine{00037\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_INET\_NTOP\_H\ */}\textcolor{preprocessor}{}}
