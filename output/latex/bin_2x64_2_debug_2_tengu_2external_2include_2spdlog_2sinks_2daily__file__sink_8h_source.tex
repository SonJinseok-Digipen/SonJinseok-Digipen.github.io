\hypertarget{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2daily__file__sink_8h_source}{}\doxysection{daily\+\_\+file\+\_\+sink.\+h}
\label{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2daily__file__sink_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/daily\_file\_sink.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/daily\_file\_sink.h}}
...
\DoxyCodeLine{00028\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structspdlog_1_1sinks_1_1daily__filename__calculator}{daily\_filename\_calculator}}}
\DoxyCodeLine{00029\ \{}
...
\DoxyCodeLine{00047\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structspdlog_1_1sinks_1_1daily__filename__format__calculator}{daily\_filename\_format\_calculator}}}
\DoxyCodeLine{00048\ \{}
...
\DoxyCodeLine{00118\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1daily__file__sink}{daily\_file\_sink}}\ final\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink}}<Mutex>}
\DoxyCodeLine{00119\ \{}
...
\DoxyCodeLine{00122\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1daily__file__sink}{daily\_file\_sink}}(filename\_t\ base\_filename,\ \textcolor{keywordtype}{int}\ rotation\_hour,\ \textcolor{keywordtype}{int}\ rotation\_minute,\ \textcolor{keywordtype}{bool}\ truncate\ =\ \textcolor{keyword}{false},\ uint16\_t\ max\_files\ =\ 0,}
\DoxyCodeLine{00123\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1file__event__handlers}{file\_event\_handlers}}\ \&event\_handlers\ =\ \{\})}
...
\DoxyCodeLine{00149\ \ \ \ \ \{}
\DoxyCodeLine{00150\ \ \ \ \ \ \ \ \ std::lock\_guard<Mutex>\ lock(\mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink<Mutex>::mutex\_}});}
\DoxyCodeLine{00151\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ file\_helper\_.filename();}
\DoxyCodeLine{00152\ \ \ \ \ \}}
\DoxyCodeLine{00153\ }
\DoxyCodeLine{00154\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00155\ \ \ \ \ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&msg)\textcolor{keyword}{\ override}}
...
\DoxyCodeLine{00166\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink<Mutex>::formatter\_}}-\/>format(msg,\ formatted);}
...
\DoxyCodeLine{00185\ }
\DoxyCodeLine{00186\ \ \ \ \ \ \ \ \ filenames\_q\_\ =\ \mbox{\hyperlink{classspdlog_1_1details_1_1circular__q}{details::circular\_q<filename\_t>}}(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(max\_files\_));}
...
\DoxyCodeLine{00252\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1file__helper}{details::file\_helper}}\ file\_helper\_;}
\DoxyCodeLine{00253\ \ \ \ \ \textcolor{keywordtype}{bool}\ truncate\_;}
\DoxyCodeLine{00254\ \ \ \ \ uint16\_t\ max\_files\_;}
\DoxyCodeLine{00255\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1circular__q}{details::circular\_q<filename\_t>}}\ filenames\_q\_;}
\DoxyCodeLine{00256\ \};}
\DoxyCodeLine{00257\ }
\DoxyCodeLine{00258\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1daily__file__sink}{daily\_file\_sink\_mt}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1daily__file__sink}{daily\_file\_sink<std::mutex>}};}
\DoxyCodeLine{00259\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1daily__file__sink}{daily\_file\_sink\_st}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1daily__file__sink}{daily\_file\_sink<details::null\_mutex>}};}
\DoxyCodeLine{00260\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1daily__file__sink}{daily\_file\_format\_sink\_mt}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1daily__file__sink}{daily\_file\_sink<std::mutex,\ daily\_filename\_format\_calculator>}};}
\DoxyCodeLine{00261\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1daily__file__sink}{daily\_file\_format\_sink\_st}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1daily__file__sink}{daily\_file\_sink<details::null\_mutex,\ daily\_filename\_format\_calculator>}};}
\DoxyCodeLine{00262\ }
...
\DoxyCodeLine{00270\ \ \ \ \ \textcolor{keywordtype}{bool}\ truncate\ =\ \textcolor{keyword}{false},\ uint16\_t\ max\_files\ =\ 0,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1file__event__handlers}{file\_event\_handlers}}\ \&event\_handlers\ =\ \{\})}
\DoxyCodeLine{00271\ \{}
