\hypertarget{stdcheaders_8h_source}{}\doxysection{stdcheaders.\+h}
\label{stdcheaders_8h_source}\index{AseSprite/aseprite/third\_party/curl/include/curl/stdcheaders.h@{AseSprite/aseprite/third\_party/curl/include/curl/stdcheaders.h}}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{keywordtype}{size\_t}\ fread(\textcolor{keywordtype}{void}\ *,\ \textcolor{keywordtype}{size\_t},\ \textcolor{keywordtype}{size\_t},\ FILE\ *);}
\DoxyCodeLine{00028\ \textcolor{keywordtype}{size\_t}\ fwrite(\textcolor{keyword}{const}\ \textcolor{keywordtype}{void}\ *,\ \textcolor{keywordtype}{size\_t},\ \textcolor{keywordtype}{size\_t},\ FILE\ *);}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{keywordtype}{int}\ strcasecmp(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *);}
\DoxyCodeLine{00031\ \textcolor{keywordtype}{int}\ strncasecmp(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *,\ \textcolor{keywordtype}{size\_t});}
\DoxyCodeLine{00032\ }
