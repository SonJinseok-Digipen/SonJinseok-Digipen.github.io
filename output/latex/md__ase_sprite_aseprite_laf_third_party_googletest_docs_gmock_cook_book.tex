You can find recipes for using g\+Mock here. If you haven\textquotesingle{}t yet, please read \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_for_dummies}{the dummy guide}} first to make sure you understand the basics.

\{\+: .callout .note\} {\bfseries{Note\+:}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md218}{}\doxysection{Creating Mock Classes}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md218}
...
\end{DoxyItemize}\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md219}{}\doxysubsection{Dealing with unprotected commas}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md219}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md220}{}\doxysubsection{Mocking Private or Protected Methods}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md220}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md221}{}\doxysubsection{Mocking Overloaded Methods}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md221}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md222}{}\doxysubsection{Mocking Class Templates}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md222}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_MockingNonVirtualMethods}{}\doxysubsection{Mocking Non-\/virtual Methods}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_MockingNonVirtualMethods}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md223}{}\doxysubsection{Mocking Free Functions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md223}
...
If you are concerned about the performance overhead incurred by virtual functions, and profiling confirms your concern, you can combine this with the recipe for \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_MockingNonVirtualMethods}{mocking non-\/virtual methods}}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md224}{}\doxysubsection{Old-\/\+Style $<$tt$>$\+MOCK\+\_\+\+METHODn$<$/tt$>$ Macros}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md224}
...
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NiceStrictNaggy}{}\doxysubsection{The Nice, the Strict, and the Naggy}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NiceStrictNaggy}
...
\DoxyCodeLine{\ \ ...\ \mbox{\hyperlink{structcode}{code}}\ that\ uses\ mock\_foo\ ...}
\DoxyCodeLine{\}}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md225}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md225}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_DelegatingToFake}{}\doxysubsection{Delegating Calls to a Fake}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_DelegatingToFake}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily IOOps} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily IOOps} without mocking {\ttfamily File\+Ops}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md226}{}\doxysubsection{Delegating Calls to a Real Object}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md226}
...
You can use the {\itshape delegating-\/to-\/real} technique to ensure that your mock has the same behavior as the real object while retaining the ability to validate calls. This technique is very similar to the \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_DelegatingToFake}{delegating-\/to-\/fake}} technique, the difference being that we use a real object instead of a fake. Here\textquotesingle{}s an example\+:
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md228}{}\doxysection{Using Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md228}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md229}{}\doxysubsection{Matching Argument Values Exactly}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md229}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md230}{}\doxysubsection{Using Simple Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md230}
...
\mbox{\hyperlink{class_a}{A}} frequently used matcher is {\ttfamily \+\_\+}, which matches anything\+:
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_CombiningMatchers}{}\doxysubsection{Combining Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_CombiningMatchers}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_SafeMatcherCast}{}\doxysubsection{Casting Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_SafeMatcherCast}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_SelectOverload}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_SelectOverload}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md231}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md231}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md232}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md232}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args\texorpdfstring{$<$}{<}0, 1\texorpdfstring{$>$}{>}(Truly(\&My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily std\+::tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md233}{}\doxysubsection{Using Matchers as Predicates}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md233}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md234}{}\doxysubsection{Using Matchers in googletest Assertions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md234}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md235}{}\doxysubsection{Using Predicates as Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md235}
g\+Mock provides a set of built-\/in matchers for matching arguments with expected values—see the \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers}{Matchers Reference}} for more information. In case you find the built-\/in set lacking, you can use an arbitrary unary predicate function or functor as a matcher -\/ as long as the predicate accepts a value of the type you want. You do this by wrapping the predicate inside the {\ttfamily Truly()} function, for example\+:
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in in statement {\ttfamily if (condition) ...}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md236}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md236}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily EXPECT\+\_\+\+CALL()}, or the result is undefined.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md237}{}\doxysubsection{Validating a Member of an Object}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md237}
...
What if you want to validate more than one members at the same time? Remember that there are \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_CombiningMatchers}{\`{}\+All\+Of()\`{} and \`{}\+All\+Of\+Array()\`{}}}.
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md238}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md238}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_CustomMatcherClass}{}\doxysubsection{Defining a Custom Matcher Class}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_CustomMatcherClass}
Most matchers can be simply defined using \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NewMatchers}{the MATCHER$\ast$ macros}}, which are terse and flexible, and produce good error messages. However, these macros are not very explicit about the interfaces they create and are not always suitable, especially for matchers that will be widely reused.

For more advanced cases, you may need to define your own matcher class. \mbox{\hyperlink{class_a}{A}} custom matcher allows you to test a specific invariant property of that object. Let\textquotesingle{}s take a look at how to do so.
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md239}{}\doxysubsection{Matching Containers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md239}
...
\end{DoxyItemize}\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md240}{}\doxysubsection{Sharing Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md240}
...
\DoxyCodeLine{\ \ ...\ use\ in\_range\ as\ \mbox{\hyperlink{structa}{a}}\ matcher\ in\ multiple\ EXPECT\_CALLs\ ...}

\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_PureMatchers}{}\doxysubsection{Matchers must have no side-\/effects}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_PureMatchers}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md241}{}\doxysection{Setting Expectations}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md241}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_UseOnCall}{}\doxysubsection{Knowing When to Expect}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_UseOnCall}
...
If you are bothered by the \char`\"{}\+Uninteresting mock function call\char`\"{} message printed when a mock method without an {\ttfamily EXPECT\+\_\+\+CALL} is called, you may use a {\ttfamily Nice\+Mock} instead to suppress all such messages for the mock object, or suppress the message for specific methods by adding {\ttfamily EXPECT\+\_\+\+CALL(...).Times(\+Any\+Number())}. DO NOT suppress it by blindly adding an {\ttfamily EXPECT\+\_\+\+CALL(...)}, or you\textquotesingle{}ll have a test that\textquotesingle{}s a pain to maintain.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md242}{}\doxysubsection{Ignoring Uninteresting Calls}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md242}
If you are not interested in how a mock method is called, just don\textquotesingle{}t say anything about it. In this case, if the method is ever called, g\+Mock will perform its default action to allow the test program to continue. If you are not happy with the default action taken by g\+Mock, you can override it using {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}::Set()} (described \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_DefaultValue}{here}}) or {\ttfamily ON\+\_\+\+CALL()}.

Please note that once you expressed interest in a particular mock method (via {\ttfamily EXPECT\+\_\+\+CALL()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily EXPECT\+\_\+\+CALL()} statement, it will be an error.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md243}{}\doxysubsection{Disallowing Unexpected Calls}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md243}
...
\mbox{\hyperlink{class_a}{A}} call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily EXPECT\+\_\+\+CALL()} statements will be an error.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_uninteresting-vs-unexpected}{}\doxysubsection{Understanding Uninteresting vs Unexpected Calls}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_uninteresting-vs-unexpected}
{\itshape Uninteresting} calls and {\itshape unexpected} calls are different concepts in g\+Mock. {\itshape Very} different.

\mbox{\hyperlink{class_a}{A}} call {\ttfamily x.\+Y(...)} is {\bfseries{uninteresting}} if there\textquotesingle{}s {\itshape not even a single} {\ttfamily EXPECT\+\_\+\+CALL(x, Y(...))} set. In other words, the test isn\textquotesingle{}t interested in the {\ttfamily x.\+Y()} method at all, as evident in that the test doesn\textquotesingle{}t care to say anything about it.

\mbox{\hyperlink{class_a}{A}} call {\ttfamily x.\+Y(...)} is {\bfseries{unexpected}} if there are {\itshape some} {\ttfamily EXPECT\+\_\+\+CALL(x, \+Y(...))}s set, but none of them matches the call. Put another way, the test is interested in the {\ttfamily x.\+Y()} method (therefore it explicitly sets some {\ttfamily EXPECT\+\_\+\+CALL} to verify how it\textquotesingle{}s called); however, the verification fails as the test doesn\textquotesingle{}t expect this particular call to happen.
...
\mbox{\hyperlink{class_a}{A}} {\bfseries{nice mock}} suppresses uninteresting call {\itshape warnings}. It is less chatty than the default mock, but otherwise is the same. If a test fails with a default mock, it will also fail using a nice mock instead. And vice versa. Don\textquotesingle{}t expect making a mock nice to change the test\textquotesingle{}s result.

\mbox{\hyperlink{class_a}{A}} {\bfseries{strict mock}} turns uninteresting call warnings into errors. So making a mock strict may change the test\textquotesingle{}s result.
...
For more on uninteresting calls, nice mocks, and strict mocks, read \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NiceStrictNaggy}{"{}The Nice, the Strict, and the Naggy"{}}}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_ParameterlessExpectations}{}\doxysubsection{Ignoring Uninteresting Arguments}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_ParameterlessExpectations}
...
This functionality is only available when a method is not overloaded; to prevent unexpected behavior it is a compilation error to try to set an expectation on a method where the specific overload is ambiguous. You can work around this by supplying a \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_SimplerInterfaces}{simpler mock interface}} than the mocked class provides.

This pattern is also useful when the arguments are interesting, but match logic is substantially complex. You can leave the argument list unspecified and use Save\+Arg actions to \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_SaveArgVerify}{save the values for later verification}}. If you do that, you can easily differentiate calling the method the wrong number of times from calling it with the wrong arguments.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_for_dummies_OrderedCalls}{}\doxysubsection{Expecting Ordered Calls}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_for_dummies_OrderedCalls}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, g\+Mock will report an error.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_PartialOrder}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_PartialOrder}
Sometimes requiring everything to occur in a predetermined order can lead to brittle tests. For example, we may care about {\ttfamily \mbox{\hyperlink{class_a}{A}}} occurring before both {\ttfamily B} and {\ttfamily C}, but aren\textquotesingle{}t interested in the relative order of {\ttfamily B} and {\ttfamily C}. In this case, the test should reflect our real intent, instead of being overly constraining.
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ EXPECT\_CALL(foo,\ \mbox{\hyperlink{class_a}{A}}())}
...
specifies the following DAG (where {\ttfamily s1} is {\ttfamily \mbox{\hyperlink{class_a}{A}} -\/\texorpdfstring{$>$}{>} B}, and {\ttfamily s2} is {\ttfamily \mbox{\hyperlink{class_a}{A}} -\/\texorpdfstring{$>$}{>} C -\/\texorpdfstring{$>$}{>} D})\+:
...
This means that \mbox{\hyperlink{class_a}{A}} must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md244}{}\doxysubsection{Controlling When an Expectation Retires}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md244}
...
\DoxyCodeLine{\ \ Sequence\ s1,\ s2;}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ EXPECT\_CALL(\mbox{\hyperlink{structlog}{log}},\ Log(WARNING,\ \_,\ \textcolor{stringliteral}{"{}File\ too\ large."{}}))\ \ \ \ \ \ \textcolor{comment}{//\ \#1}}
\DoxyCodeLine{\ \ \ \ \ \ .Times(AnyNumber())}
\DoxyCodeLine{\ \ \ \ \ \ .InSequence(s1,\ s2);}
\DoxyCodeLine{\ \ EXPECT\_CALL(\mbox{\hyperlink{structlog}{log}},\ Log(WARNING,\ \_,\ \textcolor{stringliteral}{"{}Data\ set\ is\ empty."{}}))\ \ \ \textcolor{comment}{//\ \#2}}
\DoxyCodeLine{\ \ \ \ \ \ .InSequence(s1);}
\DoxyCodeLine{\ \ EXPECT\_CALL(\mbox{\hyperlink{structlog}{log}},\ Log(WARNING,\ \_,\ \textcolor{stringliteral}{"{}User\ not\ found."{}}))\ \ \ \ \ \ \textcolor{comment}{//\ \#3}}
\DoxyCodeLine{\ \ \ \ \ \ .InSequence(s2);}
...
\DoxyCodeLine{using\ ::testing::\_;}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ EXPECT\_CALL(\mbox{\hyperlink{structlog}{log}},\ Log(WARNING,\ \_,\ \_));\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \#1}}
\DoxyCodeLine{\ \ EXPECT\_CALL(\mbox{\hyperlink{structlog}{log}},\ Log(WARNING,\ \_,\ \textcolor{stringliteral}{"{}File\ too\ large."{}}));\ \ \ \ \ \textcolor{comment}{//\ \#2}}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md245}{}\doxysection{Using Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md245}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md246}{}\doxysubsection{Returning References from Mock Methods}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md246}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md247}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md247}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md248}{}\doxysubsection{Combining Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md248}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_SaveArgVerify}{}\doxysubsection{Verifying Complex Arguments}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_SaveArgVerify}
...
\DoxyCodeLine{...\ run\ the\ \mbox{\hyperlink{structtest}{test}}}
\DoxyCodeLine{EXPECT\_THAT(actual\_array,\ ElementsAre(1,\ 4,\ 4,\ 7));}
\DoxyCodeLine{EXPECT\_THAT(actual\_proto,\ EqualsProto(\ ...\ ));}

\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_MockingSideEffects}{}\doxysubsection{Mocking Side Effects}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_MockingSideEffects}
...
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
\DoxyCodeLine{\ \ MOCK\_METHOD(\textcolor{keywordtype}{void},\ Mutate,\ (\textcolor{keywordtype}{bool}\ mutate,\ \textcolor{keywordtype}{int}*\ \mbox{\hyperlink{classvalue}{value}}),\ (\textcolor{keyword}{override}));}
\DoxyCodeLine{\ \ ...}
\DoxyCodeLine{\}}
\DoxyCodeLine{...}
...
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
\DoxyCodeLine{\ \ ...}
\DoxyCodeLine{\ \ MOCK\_METHOD(\textcolor{keywordtype}{bool},\ MutateInt,\ (\textcolor{keywordtype}{int}*\ \mbox{\hyperlink{classvalue}{value}}),\ (\textcolor{keyword}{override}));}
\DoxyCodeLine{\}}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ MockMutator\ mutator;}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md249}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md249}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_DefaultValue}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_DefaultValue}
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md250}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md250}
...
Note that both {\ttfamily ON\+\_\+\+CALL} and {\ttfamily EXPECT\+\_\+\+CALL} have the same \char`\"{}later statements take precedence\char`\"{} rule, but they don\textquotesingle{}t interact. That is, {\ttfamily EXPECT\+\_\+\+CALL}s have their own precedence order distinct from the {\ttfamily ON\+\_\+\+CALL} precedence order.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_FunctionsAsActions}{}\doxysubsection{Using Functions/\+Methods/\+Functors/\+Lambdas as Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_FunctionsAsActions}
...
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
\DoxyCodeLine{\ \ MOCK\_METHOD(\textcolor{keywordtype}{int},\ \mbox{\hyperlink{struct_sum}{Sum}},\ (\textcolor{keywordtype}{int}\ x,\ \textcolor{keywordtype}{int}\ y),\ (\textcolor{keyword}{override}));}
...
\DoxyCodeLine{\ \ EXPECT\_CALL(foo,\ \mbox{\hyperlink{struct_sum}{Sum}}(\_,\ \_))}
...
\end{DoxyItemize}\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md251}{}\doxysubsection{Using Functions with Extra Info as Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md251}
...
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{TEST\_F(FooTest,\ \mbox{\hyperlink{class_test}{Test}})\ \{}
\DoxyCodeLine{\ \ MockFoo\ foo;}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md252}{}\doxysubsection{Invoking a Function/\+Method/\+Functor/\+Lambda/\+Callback Without Arguments}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md252}
...
\end{DoxyItemize}\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md253}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md253}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md254}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md254}
...
\DoxyCodeLine{using\ ::testing::Return;}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ Process(\textcolor{keyword}{const}\ MyData\&\ \mbox{\hyperlink{structdata}{data}});}
\DoxyCodeLine{\textcolor{keywordtype}{string}\ DoSomething();}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
\DoxyCodeLine{\ \ MOCK\_METHOD(\textcolor{keywordtype}{void},\ Abc,\ (\textcolor{keyword}{const}\ MyData\&\ \mbox{\hyperlink{structdata}{data}}),\ (\textcolor{keyword}{override}));}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_SelectingArgs}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_SelectingArgs}
...
\end{DoxyItemize}\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md255}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md255}
The \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_SelectingArgs}{selecting-\/an-\/action\textquotesingle{}s-\/arguments}} recipe showed us one way to make a mock function and an action with incompatible argument lists fit together. The downside is that wrapping the action in {\ttfamily With\+Args\texorpdfstring{$<$}{<}...\texorpdfstring{$>$}{>}()} can get tedious for people writing the tests.
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md256}{}\doxysubsection{Sharing Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md256}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md257}{}\doxysubsection{Testing Asynchronous Behavior}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md257}
One oft-\/encountered problem with g\+Mock is that it can be hard to test asynchronous behavior. Suppose you had a {\ttfamily Event\+Queue} class that you wanted to test, and you created a separate {\ttfamily Event\+Dispatcher} interface so that you could easily mock it out. However, the implementation of the class fired all the events on a background thread, which made test timings difficult. You could just insert {\ttfamily sleep()} statements and hope for the best, but that makes your test behavior nondeterministic. \mbox{\hyperlink{class_a}{A}} better way is to use g\+Mock actions and {\ttfamily Notification} objects to force your asynchronous test to behave synchronously.
...
\{\+: .callout .note\} Note\+: this example has a downside\+: namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md258}{}\doxysection{Misc Recipes on Using g\+Mock}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md258}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md259}{}\doxysubsection{Mocking Methods That Use Move-\/\+Only Types}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md259}
C++11 introduced {\itshape move-\/only types}. \mbox{\hyperlink{class_a}{A}} move-\/only-\/typed value can be moved from one object to another, but cannot be copied. {\ttfamily std\+::unique\+\_\+ptr\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is probably the most commonly used move-\/only type.

Mocking a method that takes and/or returns move-\/only types presents some challenges, but nothing insurmountable. This recipe shows you how you can do it. Note that the support for move-\/only method arguments was only introduced to g\+Mock in April 2017; in older code, you may find more complex \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_LegacyMoveOnly}{workarounds}} for lack of this feature.
...
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
\DoxyCodeLine{\ \ \textcolor{keyword}{explicit}\ Buzz(AccessLevel\ \mbox{\hyperlink{structaccess}{access}})\ \{\ ...\ \}}
\DoxyCodeLine{\ \ ...}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
...
\mbox{\hyperlink{class_a}{A}} {\ttfamily Buzz} object represents a snippet being posted. \mbox{\hyperlink{class_a}{A}} class that implements the {\ttfamily Buzzer} interface is capable of creating and sharing {\ttfamily Buzz}es. Methods in {\ttfamily Buzzer} may return a {\ttfamily unique\+\_\+ptr\texorpdfstring{$<$}{<}Buzz\texorpdfstring{$>$}{>}} or take a {\ttfamily unique\+\_\+ptr\texorpdfstring{$<$}{<}Buzz\texorpdfstring{$>$}{>}}. Now we need to mock {\ttfamily Buzzer} in our tests.
...
If you are not happy with the default action, you can tweak it as usual; see \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cheat_sheet_OnCall}{Setting Default Actions}}.
...
\mbox{\hyperlink{class_a}{A}} few actions (e.\+g. {\ttfamily Do\+All}) copy their arguments internally, so they can never work with non-\/copyable objects; you\textquotesingle{}ll have to use functors instead.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_LegacyMoveOnly}{}\doxysubsubsection{Legacy workarounds for move-\/only types}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_LegacyMoveOnly}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md260}{}\doxysubsection{Making the Compilation Faster}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md260}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md261}{}\doxysubsection{Forcing a Verification}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md261}
...
\mbox{\hyperlink{class_a}{A}} technique you can use is to put the expectations in a sequence and insert calls to a dummy \char`\"{}checkpoint\char`\"{} function at specific places. Then you can verify that the mock function calls do happen at the right time. For example, if you are exercising the code\+:
...
\DoxyCodeLine{\ \ EXPECT\_CALL(*bar,\ \mbox{\hyperlink{class_a}{A}}());}
...
And that\textquotesingle{}s that.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_UsingThreads}{}\doxysubsection{Using g\+Mock and Threads}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_UsingThreads}
...
Also, remember that {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md263}{}\doxysubsection{Controlling How Much Information g\+Mock Prints}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md263}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md264}{}\doxysubsection{Gaining Super Vision into Mock Calls}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md264}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md265}{}\doxysubsection{Running Tests in Emacs}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md265}
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md266}{}\doxysection{Extending g\+Mock}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md266}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NewMatchers}{}\doxysubsection{Writing New Matchers Quickly}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NewMatchers}
\{\+: .callout .warning\} WARNING\+: g\+Mock does not guarantee when or how many times a matcher will be invoked. Therefore, all matchers must be functionally pure. See \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_PureMatchers}{this section}} for more details.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{MATCHER\_P(HasAbsoluteValue,\ \mbox{\hyperlink{classvalue}{value}},\ \textcolor{stringliteral}{"{}"{}})\ \{\ \textcolor{keywordflow}{return}\ abs(arg)\ ==\ \mbox{\hyperlink{classvalue}{value}};\ \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{MATCHER\_P(Blah,\ \mbox{\hyperlink{structa}{a}},\ description\_string\_1)\ \{\ ...\ \}}
\DoxyCodeLine{MATCHER\_P2(Blah,\ \mbox{\hyperlink{structa}{a}},\ b,\ description\_string\_2)\ \{\ ...\ \}}

\end{DoxyCode}


While it\textquotesingle{}s tempting to always use the {\ttfamily MATCHER$\ast$} macros when defining a new matcher, you should also consider implementing the matcher interface directly instead (see the recipes that follow), especially if you need to use the matcher a lot. While these approaches require more work, they give you more control on the types of the value being matched and the matcher parameters, which in general leads to better compiler error messages that pay off in the long run. They also allow overloading matchers based on parameter types (as opposed to just based on the number of parameters).\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md268}{}\doxysubsection{Writing New Monomorphic Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md268}
\mbox{\hyperlink{class_a}{A}} matcher of argument type {\ttfamily T} implements the matcher interface for {\ttfamily T} and does two things\+: it tests whether a value of type {\ttfamily T} matches the matcher, and can describe what kind of values it matches. The latter ability is used for generating readable error messages when expectations are violated.

\mbox{\hyperlink{class_a}{A}} matcher of {\ttfamily T} must declare a typedef like\+:
...
\DoxyCodeLine{\textcolor{keywordtype}{bool}\ matched\ =\ matcher.MatchAndExplain(\mbox{\hyperlink{classvalue}{value}},\ maybe\_os);}
...
\{\+: .callout .tip\} Tip\+: for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener$\ast$} instead of {\ttfamily std\+::ostream$\ast$}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md269}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md269}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md270}{}\doxysubsection{Legacy Matcher Implementation}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md270}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md271}{}\doxysubsection{Writing New Cardinalities}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md271}
\mbox{\hyperlink{class_a}{A}} cardinality is used in {\ttfamily Times()} to tell g\+Mock how many times you expect a call to occur. It doesn\textquotesingle{}t have to be exact. For example, you can say {\ttfamily At\+Least(5)} or {\ttfamily Between(2, 4)}.
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_QuickNewActions}{}\doxysubsection{Writing New Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_QuickNewActions}
...
Typically the {\ttfamily Once\+Action} and {\ttfamily Action} templates need not be referenced directly in your actions\+: a struct or class with a call operator is sufficient, as in the examples above. But fancier polymorphic actions that need to know the specific return type of the mock function can define templated conversion operators to make that possible. See {\ttfamily \mbox{\hyperlink{gmock-actions_8h_source}{gmock-\/actions.\+h}}} for examples.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md272}{}\doxysubsubsection{Legacy macro-\/based Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md272}
...
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md273}{}\doxysubsubsection{Legacy macro-\/based parameterized Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md273}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{ACTION\_P(Plus,\ \mbox{\hyperlink{structa}{a}})\ \{\ ...\ \}}
\DoxyCodeLine{ACTION\_P2(Plus,\ \mbox{\hyperlink{structa}{a}},\ b)\ \{\ ...\ \}}

\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md274}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an ACTION}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md274}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md275}{}\doxysubsection{Writing New Action Templates Quickly}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md275}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md276}{}\doxysubsection{Using the ACTION Object\textquotesingle{}s Type}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md276}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NewMonoActions}{}\doxysubsection{Writing New Monomorphic Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NewMonoActions}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NewPolyActions}{}\doxysubsection{Writing New Polymorphic Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NewPolyActions}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md277}{}\doxysubsection{Teaching g\+Mock How to Print Your Values}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md277}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<}} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{ The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md278}{}\doxysection{Useful Mocks Created Using g\+Mock}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_autotoc_md278}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_MockFunction}{}\doxysubsection{Mock std\+::function}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_MockFunction}
