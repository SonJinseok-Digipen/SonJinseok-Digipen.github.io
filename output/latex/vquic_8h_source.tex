\hypertarget{vquic_8h_source}{}\doxysection{vquic.\+h}
\label{vquic_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/vquic/vquic.h@{AseSprite/aseprite/third\_party/curl/lib/vquic/vquic.h}}
...
\DoxyCodeLine{00028\ CURLcode\ Curl\_qlogdir(\textcolor{keyword}{struct}\ \mbox{\hyperlink{struct_curl__easy}{Curl\_easy}}\ *\mbox{\hyperlink{structdata}{data}},}
\DoxyCodeLine{00029\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *scid,}
\DoxyCodeLine{00030\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{size\_t}\ scidlen,}
\DoxyCodeLine{00031\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ *qlogfdp);}
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_VQUIC\_QUIC\_H\ */}\textcolor{preprocessor}{}}
