\hypertarget{hb-glib_8h_source}{}\doxysection{hb-\/glib.h}
\label{hb-glib_8h_source}\index{AseSprite/aseprite/third\_party/harfbuzz/src/hb-\/glib.h@{AseSprite/aseprite/third\_party/harfbuzz/src/hb-\/glib.h}}
...
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#ifndef\ HB\_GLIB\_H}}
\DoxyCodeLine{00030\ \textcolor{preprocessor}{\#define\ HB\_GLIB\_H}}
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#include\ "{}hb.h"{}}}
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#include\ <glib.h>}}
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ HB\_BEGIN\_DECLS}
\DoxyCodeLine{00037\ }
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00039\ HB\_EXTERN\ hb\_script\_t}
\DoxyCodeLine{00040\ hb\_glib\_script\_to\_script\ (GUnicodeScript\ script);}
\DoxyCodeLine{00041\ }
\DoxyCodeLine{00042\ HB\_EXTERN\ GUnicodeScript}
\DoxyCodeLine{00043\ hb\_glib\_script\_from\_script\ (hb\_script\_t\ script);}
\DoxyCodeLine{00044\ }
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00046\ HB\_EXTERN\ \mbox{\hyperlink{structhb__unicode__funcs__t}{hb\_unicode\_funcs\_t}}\ *}
\DoxyCodeLine{00047\ hb\_glib\_get\_unicode\_funcs\ (\textcolor{keywordtype}{void});}
\DoxyCodeLine{00048\ }
\DoxyCodeLine{00049\ \textcolor{preprocessor}{\#if\ GLIB\_CHECK\_VERSION(2,31,10)}}
\DoxyCodeLine{00050\ HB\_EXTERN\ \mbox{\hyperlink{structhb__blob__t}{hb\_blob\_t}}\ *}
\DoxyCodeLine{00051\ hb\_glib\_blob\_create\ (GBytes\ *gbytes);}
\DoxyCodeLine{00052\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00053\ }
\DoxyCodeLine{00054\ HB\_END\_DECLS}
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HB\_GLIB\_H\ */}\textcolor{preprocessor}{}}
