\hypertarget{archive__cmdline__private_8h_source}{}\doxysection{archive\+\_\+cmdline\+\_\+private.\+h}
\label{archive__cmdline__private_8h_source}\index{AseSprite/aseprite/third\_party/libarchive/libarchive/archive\_cmdline\_private.h@{AseSprite/aseprite/third\_party/libarchive/libarchive/archive\_cmdline\_private.h}}

\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{comment}{/*-\/}}
\DoxyCodeLine{00002\ \textcolor{comment}{\ *\ Copyright\ (c)\ 2012\ Michihiro\ NAKAJIMA}}
...
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#ifndef\ ARCHIVE\_CMDLINE\_PRIVATE\_H}}
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#define\ ARCHIVE\_CMDLINE\_PRIVATE\_H}}
\DoxyCodeLine{00030\ }
...
\DoxyCodeLine{00036\ }
\DoxyCodeLine{00037\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structarchive__cmdline}{archive\_cmdline}}\ \{}
\DoxyCodeLine{00038\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{char}\ \ \ \ \ \ \ \ \ \ \ \ *path;}
\DoxyCodeLine{00039\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{char}\ \ \ \ \ \ \ \ \ \ \ \ **argv;}
\DoxyCodeLine{00040\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ \ \ \ \ \ \ \ \ \ \ \ \ \ argc;}
\DoxyCodeLine{00041\ \};}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structarchive__cmdline}{archive\_cmdline}}\ *\_\_archive\_cmdline\_allocate(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00044\ \textcolor{keywordtype}{int}\ \_\_archive\_cmdline\_parse(\textcolor{keyword}{struct}\ \mbox{\hyperlink{structarchive__cmdline}{archive\_cmdline}}\ *,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *);}
\DoxyCodeLine{00045\ \textcolor{keywordtype}{int}\ \_\_archive\_cmdline\_free(\textcolor{keyword}{struct}\ \mbox{\hyperlink{structarchive__cmdline}{archive\_cmdline}}\ *);}
\DoxyCodeLine{00046\ }
