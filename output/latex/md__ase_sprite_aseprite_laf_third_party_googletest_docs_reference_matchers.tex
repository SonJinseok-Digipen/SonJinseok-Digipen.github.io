\mbox{\hyperlink{class_a}{A}} {\bfseries{matcher}} matches a {\itshape single} argument. You can use it inside {\ttfamily ON\+\_\+\+CALL()} or {\ttfamily EXPECT\+\_\+\+CALL()}, or use it to validate a value directly using two macros\+:
...
Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily \+::testing} namespace unless otherwise noted.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md351}{}\doxysection{Wildcard}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md351}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
{\ttfamily \mbox{\hyperlink{class_a}{A}}\texorpdfstring{$<$}{<}type\texorpdfstring{$>$}{>}()} or {\ttfamily An\texorpdfstring{$<$}{<}type\texorpdfstring{$>$}{>}()}   &{\ttfamily argument} can be any value of type {\ttfamily type}.   \\\cline{1-2}
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md352}{}\doxysection{Generic Comparison}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md352}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Is\+True} and {\ttfamily Is\+False} are useful when you need to use a matcher, or for types that can be explicitly converted to Boolean, but are not implicitly converted to Boolean. In other cases, you can use the basic \href{assertions.md\#boolean}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE} and {\ttfamily EXPECT\+\_\+\+FALSE}}} assertions.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_FpMatchers}{}\doxysection{Floating-\/\+Point Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_FpMatchers}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md353}{}\doxysection{String Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md353}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md354}{}\doxysection{Container Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md354}
...
\item an array passed as a pointer and a count (e.\+g. in {\ttfamily Bar(const T$\ast$ buffer,         int len)} -- see \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_MultiArgMatchers}{Multi-\/argument Matchers}}).
\end{DoxyEnumerate}
...
\end{DoxyItemize}\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md355}{}\doxysection{Member Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md355}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{DoxyItemize}\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md356}{}\doxysection{Matching the Result of a Function, Functor, or Callback}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md356}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md357}{}\doxysection{Pointer Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md357}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_MultiArgMatchers}{}\doxysection{Multi-\/argument Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_MultiArgMatchers}
Technically, all matchers match a {\itshape single} value. \mbox{\hyperlink{class_a}{A}} \char`\"{}multi-\/argument\char`\"{} matcher is just one that matches a {\itshape tuple}. The following matchers can be used to match a tuple {\ttfamily (x, y)}\+:
...
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md358}{}\doxysection{Composite Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md358}
...
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md359}{}\doxysection{Adapters for Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md359}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Address\+Satisfies(callback)} and {\ttfamily Truly(callback)} take ownership of {\ttfamily callback}, which must be a permanent callback.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_MatchersAsPredicatesCheat}{}\doxysection{Using Matchers as Predicates}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_MatchersAsPredicatesCheat}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily \mbox{\hyperlink{union_value}{Value(value, m)}}}   &evaluates to {\ttfamily true} if {\ttfamily value} matches {\ttfamily m}.   \\\cline{1-2}
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md360}{}\doxysection{Defining Matchers}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers_autotoc_md360}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
