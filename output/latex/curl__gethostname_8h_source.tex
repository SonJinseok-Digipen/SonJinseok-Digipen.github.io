\hypertarget{curl__gethostname_8h_source}{}\doxysection{curl\+\_\+gethostname.\+h}
\label{curl__gethostname_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/curl\_gethostname.h@{AseSprite/aseprite/third\_party/curl/lib/curl\_gethostname.h}}
...
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{comment}{/*\ Hostname\ buffer\ size\ */}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#define\ HOSTNAME\_MAX\ 1024}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{comment}{/*\ This\ returns\ the\ local\ machine's\ un-\/qualified\ hostname\ */}}
\DoxyCodeLine{00029\ \textcolor{keywordtype}{int}\ Curl\_gethostname(\textcolor{keywordtype}{char}\ *\ \textcolor{keyword}{const}\ name,\ GETHOSTNAME\_TYPE\_ARG2\ namelen);}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_GETHOSTNAME\_H\ */}\textcolor{preprocessor}{}}
