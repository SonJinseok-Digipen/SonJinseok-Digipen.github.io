\hypertarget{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2qt__sinks_8h_source}{}\doxysection{qt\+\_\+sinks.\+h}
\label{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2qt__sinks_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/qt\_sinks.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/qt\_sinks.h}}
...
\DoxyCodeLine{00025\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1qt__sink}{qt\_sink}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink}}<Mutex>}
\DoxyCodeLine{00026\ \{}
\DoxyCodeLine{00027\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00028\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1qt__sink}{qt\_sink}}(QObject\ *qt\_object,\ \textcolor{keyword}{const}\ std::string\ \&meta\_method)}
\DoxyCodeLine{00029\ \ \ \ \ \{}
\DoxyCodeLine{00030\ \ \ \ \ \ \ \ \ qt\_object\_\ =\ qt\_object;}
\DoxyCodeLine{00031\ \ \ \ \ \ \ \ \ meta\_method\_\ =\ meta\_method;}
\DoxyCodeLine{00032\ \ \ \ \ \}}
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1qt__sink}{\string~qt\_sink}}()}
\DoxyCodeLine{00035\ \ \ \ \ \{}
\DoxyCodeLine{00036\ \ \ \ \ \ \ \ \ flush\_();}
\DoxyCodeLine{00037\ \ \ \ \ \}}
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00039\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00040\ \ \ \ \ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&msg)\textcolor{keyword}{\ override}}
\DoxyCodeLine{00041\ \textcolor{keyword}{\ \ \ \ }\{}
\DoxyCodeLine{00042\ \ \ \ \ \ \ \ \ memory\_buf\_t\ formatted;}
\DoxyCodeLine{00043\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink<Mutex>::formatter\_}}-\/>format(msg,\ formatted);}
...
\DoxyCodeLine{00058\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1qt__sink}{qt\_sink\_mt}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1qt__sink}{qt\_sink<std::mutex>}};}
\DoxyCodeLine{00059\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1qt__sink}{qt\_sink\_st}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1qt__sink}{qt\_sink<spdlog::details::null\_mutex>}};}
