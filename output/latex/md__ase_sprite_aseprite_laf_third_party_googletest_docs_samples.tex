...
\item Sample \#9 shows use of the listener API to modify Google \mbox{\hyperlink{class_test}{Test}}\textquotesingle{}s console output and the use of its reflection API to inspect test results.
