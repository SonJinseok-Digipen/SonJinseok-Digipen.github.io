\hypertarget{curl__range_8h_source}{}\doxysection{curl\+\_\+range.\+h}
\label{curl__range_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/curl\_range.h@{AseSprite/aseprite/third\_party/curl/lib/curl\_range.h}}
...
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ CURLcode\ Curl\_range(\textcolor{keyword}{struct}\ \mbox{\hyperlink{struct_curl__easy}{Curl\_easy}}\ *\mbox{\hyperlink{structdata}{data}});}
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_RANGE\_H\ */}\textcolor{preprocessor}{}}
