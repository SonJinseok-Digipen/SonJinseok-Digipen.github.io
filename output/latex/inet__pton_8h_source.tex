\hypertarget{inet__pton_8h_source}{}\doxysection{inet\+\_\+pton.\+h}
\label{inet__pton_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/inet\_pton.h@{AseSprite/aseprite/third\_party/curl/lib/inet\_pton.h}}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{keywordtype}{int}\ Curl\_inet\_pton(\textcolor{keywordtype}{int},\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *,\ \textcolor{keywordtype}{void}\ *);}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#ifdef\ HAVE\_INET\_PTON}}
\DoxyCodeLine{00030\ \textcolor{preprocessor}{\#ifdef\ HAVE\_ARPA\_INET\_H}}
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#include\ <arpa/inet.h>}}
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#elif\ defined(HAVE\_WS2TCPIP\_H)}}
\DoxyCodeLine{00033\ \textcolor{comment}{/*\ inet\_pton()\ exists\ in\ Vista\ or\ later\ */}}
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#include\ <ws2tcpip.h>}}
\DoxyCodeLine{00035\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00036\ \textcolor{preprocessor}{\#define\ Curl\_inet\_pton(x,y,z)\ inet\_pton(x,y,z)}}
\DoxyCodeLine{00037\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00039\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_INET\_PTON\_H\ */}\textcolor{preprocessor}{}}
