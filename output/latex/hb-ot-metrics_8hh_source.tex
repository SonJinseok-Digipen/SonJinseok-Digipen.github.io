\hypertarget{hb-ot-metrics_8hh_source}{}\doxysection{hb-\/ot-\/metrics.hh}
\label{hb-ot-metrics_8hh_source}\index{AseSprite/aseprite/third\_party/harfbuzz/src/hb-\/ot-\/metrics.hh@{AseSprite/aseprite/third\_party/harfbuzz/src/hb-\/ot-\/metrics.hh}}
...
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#ifndef\ HB\_OT\_METRICS\_HH}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#define\ HB\_OT\_METRICS\_HH}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#include\ "{}hb.hh"{}}}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ HB\_INTERNAL\ \textcolor{keywordtype}{bool}}
\DoxyCodeLine{00031\ \_hb\_ot\_metrics\_get\_position\_common\ (\mbox{\hyperlink{structhb__font__t}{hb\_font\_t}}\ \ \ \ \ \ \ \ \ \ \ *font,}
\DoxyCodeLine{00032\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ hb\_ot\_metrics\_tag\_t\ \ metrics\_tag,}
\DoxyCodeLine{00033\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ hb\_position\_t\ \ \ \ \ \ \ *position\ \ \ \ \ \textcolor{comment}{/*\ OUT.\ \ May\ be\ NULL.\ */});}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HB\_OT\_METRICS\_HH\ */}\textcolor{preprocessor}{}}
