\hypertarget{wolfssl_8h_source}{}\doxysection{wolfssl.\+h}
\label{wolfssl_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/vtls/wolfssl.h@{AseSprite/aseprite/third\_party/curl/lib/vtls/wolfssl.h}}
...
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#ifdef\ USE\_WOLFSSL}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{keyword}{extern}\ \textcolor{keyword}{const}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{struct_curl__ssl}{Curl\_ssl}}\ Curl\_ssl\_wolfssl;}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ USE\_WOLFSSL\ */}\textcolor{preprocessor}{}}
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_WOLFSSL\_H\ */}\textcolor{preprocessor}{}}
