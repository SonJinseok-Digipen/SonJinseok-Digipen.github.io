\hypertarget{socketpair_8h_source}{}\doxysection{socketpair.\+h}
\label{socketpair_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/socketpair.h@{AseSprite/aseprite/third\_party/curl/lib/socketpair.h}}
...
\DoxyCodeLine{00010\ \textcolor{comment}{\ *\ Copyright\ (C)\ 2019\ -\/\ 2021,\ Daniel\ Stenberg,\ <daniel@haxx.se>,\ et\ al.}}
...
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#ifndef\ HAVE\_SOCKETPAIR}}
\DoxyCodeLine{00027\ \textcolor{keywordtype}{int}\ Curl\_socketpair(\textcolor{keywordtype}{int}\ domain,\ \textcolor{keywordtype}{int}\ type,\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{namespaceprotocol}{protocol}},}
\DoxyCodeLine{00028\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ curl\_socket\_t\ socks[2]);}
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00030\ \textcolor{preprocessor}{\#define\ Curl\_socketpair(a,b,c,d)\ socketpair(a,b,c,d)}}
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_SOCKETPAIR\_H\ */}\textcolor{preprocessor}{}}
