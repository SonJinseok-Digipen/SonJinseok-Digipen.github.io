\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md280}{}\doxysubsection{When I call a method on my mock object, the method for the real object is invoked instead. What\textquotesingle{}s the problem?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md280}
In order for a method to be mocked, it must be {\itshape virtual}, unless you use the \href{gmock_cook_book.md\#MockingNonVirtualMethods}{\texttt{ high-\/perf dependency injection technique}}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md281}{}\doxysubsection{Can I mock a variadic function?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md281}
...
Ellipsis arguments are inherited from C and not really a C++ feature. They are unsafe to use and don\textquotesingle{}t work with arguments that have constructors or destructors. Therefore we recommend to avoid them in C++ as much as possible.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md282}{}\doxysubsection{MSVC gives me warning C4301 or C4373 when I define a mock method with a const parameter. Why?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md282}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md283}{}\doxysubsection{I can\textquotesingle{}t figure out why g\+Mock thinks my expectations are not satisfied. What should I do?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md283}
...
If you see the message \char`\"{}\+The mock function has no default action set, and its return type has no default value set.\char`\"{}, then try \href{gmock_cheat_sheet.md\#OnCall}{\texttt{ adding a default action}}. Due to a known issue, unexpected calls on mocks without default actions don\textquotesingle{}t print out a detailed comparison between the actual arguments and the expected arguments.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md284}{}\doxysubsection{My program crashed and $<$tt$>$\+Scoped\+Mock\+Log$<$/tt$>$ spit out tons of messages. Is it a g\+Mock bug?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md284}
...
\DoxyCodeLine{\ \ EXPECT\_CALL(\mbox{\hyperlink{structlog}{log}},\ Log(\_,\ Not(EndsWith(\textcolor{stringliteral}{"{}/my\_file.cc"{}})),\ \_))}
\DoxyCodeLine{\ \ \ \ \ \ .Times(AnyNumber());}

\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md285}{}\doxysubsection{How can I assert that a function is NEVER called?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md285}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md286}{}\doxysubsection{I have a failed test where g\+Mock tells me TWICE that a particular expectation is not satisfied. Isn\textquotesingle{}t this redundant?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md286}
...
By changing {\ttfamily $\sim$\+Base()} to virtual, {\ttfamily $\sim$\+Derived()} will be correctly called when {\ttfamily delete p} is executed, and the heap checker will be happy.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md288}{}\doxysubsection{The \char`\"{}newer expectations override older ones\char`\"{} rule makes writing expectations awkward. Why does g\+Mock do that?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md288}
...
Also, you can control the verbosity by specifying {\ttfamily -\/-\/gmock\+\_\+verbose=error}. Other values are {\ttfamily info} and {\ttfamily warning}. If you find the output too noisy when debugging, just choose a less verbose level.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md290}{}\doxysubsection{How can I delete the mock function\textquotesingle{}s argument in an action?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md290}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md291}{}\doxysubsection{How can I perform an arbitrary action on a mock function\textquotesingle{}s argument?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md291}
If you find yourself needing to perform some action that\textquotesingle{}s not supported by g\+Mock directly, remember that you can define your own actions using \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NewMonoActions}{\`{}\+Make\+Action()\`{}}} or \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_NewPolyActions}{\`{}\+Make\+Polymorphic\+Action()\`{}}}, or you can write a stub function and invoke it using \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_cook_book_FunctionsAsActions}{\`{}\+Invoke()\`{}}}.
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md292}{}\doxysubsection{My code calls a static/global function. Can I mock it?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md292}
...
This Google Testing Blog \href{https://testing.googleblog.com/2008/06/defeat-static-cling.html}{\texttt{ post}} says it excellently. Check it out.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md293}{}\doxysubsection{My mock object needs to do complex stuff. It\textquotesingle{}s a lot of pain to specify the actions. g\+Mock sucks!}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md293}
...
See this \href{gmock_cook_book.md\#mocking-side-effects}{\texttt{ recipe}} for more details and an example.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md297}{}\doxysubsection{I have a huge mock class, and Microsoft Visual C++ runs out of memory when compiling it. What can I do?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_gmock_faq_autotoc_md297}
