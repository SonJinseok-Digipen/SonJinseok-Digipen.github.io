\hypertarget{external_2include_2spdlog_2sinks_2dist__sink_8h_source}{}\doxysection{dist\+\_\+sink.\+h}
\label{external_2include_2spdlog_2sinks_2dist__sink_8h_source}\index{Tengu/external/include/spdlog/sinks/dist\_sink.h@{Tengu/external/include/spdlog/sinks/dist\_sink.h}}
...
\DoxyCodeLine{00026\ \ \ \ \ dist\_sink()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00027\ \ \ \ \ \textcolor{keyword}{explicit}\ dist\_sink(std::vector<std::shared\_ptr<sink>>\ sinks)}
\DoxyCodeLine{00028\ \ \ \ \ \ \ \ \ :\ sinks\_(sinks)}
\DoxyCodeLine{00029\ \ \ \ \ \{\}}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \ \ \ \ dist\_sink(\textcolor{keyword}{const}\ dist\_sink\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00032\ \ \ \ \ dist\_sink\ \&operator=(\textcolor{keyword}{const}\ dist\_sink\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \ \ \ \ \textcolor{keywordtype}{void}\ add\_sink(std::shared\_ptr<sink>\ sub\_sink)}
\DoxyCodeLine{00035\ \ \ \ \ \{}
\DoxyCodeLine{00036\ \ \ \ \ \ \ \ \ std::lock\_guard<Mutex>\ lock(base\_sink<Mutex>::mutex\_);}
...
\DoxyCodeLine{00041\ \ \ \ \ \{}
\DoxyCodeLine{00042\ \ \ \ \ \ \ \ \ std::lock\_guard<Mutex>\ lock(base\_sink<Mutex>::mutex\_);}
...
\DoxyCodeLine{00047\ \ \ \ \ \{}
\DoxyCodeLine{00048\ \ \ \ \ \ \ \ \ std::lock\_guard<Mutex>\ lock(base\_sink<Mutex>::mutex\_);}
...
\DoxyCodeLine{00058\ \ \ \ \ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ details::log\_msg\ \&msg)\textcolor{keyword}{\ override}}
...
\DoxyCodeLine{00084\ \ \ \ \ \ \ \ \ base\_sink<Mutex>::formatter\_\ =\ std::move(sink\_formatter);}
\DoxyCodeLine{00085\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{auto}\ \&sub\_sink\ :\ sinks\_)}
\DoxyCodeLine{00086\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00087\ \ \ \ \ \ \ \ \ \ \ \ \ sub\_sink-\/>set\_formatter(base\_sink<Mutex>::formatter\_-\/>clone());}
\DoxyCodeLine{00088\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00089\ \ \ \ \ \}}
\DoxyCodeLine{00090\ \ \ \ \ std::vector<std::shared\_ptr<sink>>\ sinks\_;}
\DoxyCodeLine{00091\ \};}
\DoxyCodeLine{00092\ }
\DoxyCodeLine{00093\ \textcolor{keyword}{using\ }dist\_sink\_mt\ =\ dist\_sink<std::mutex>;}
\DoxyCodeLine{00094\ \textcolor{keyword}{using\ }dist\_sink\_st\ =\ dist\_sink<details::null\_mutex>;}
\DoxyCodeLine{00095\ }
