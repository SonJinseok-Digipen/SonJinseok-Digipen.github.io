...
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_actions_autotoc_md344}{}\doxysection{Side Effects}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_actions_autotoc_md344}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_actions_autotoc_md345}{}\doxysection{Using a Function, Functor, or Lambda as an Action}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_actions_autotoc_md345}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{union_closure}{Closure}}*\ done2\ =\ \textcolor{keyword}{new}\ BlockingClosure;}
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_actions_autotoc_md346}{}\doxysection{Default Action}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_actions_autotoc_md346}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_actions_autotoc_md347}{}\doxysection{Composite Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_actions_autotoc_md347}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_actions_autotoc_md348}{}\doxysection{Defining Actions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_actions_autotoc_md348}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endhead
{\ttfamily ACTION(\+Sum) \{ return arg0 + arg1; \}}   &Defines an action {\ttfamily \mbox{\hyperlink{struct_sum}{Sum()}}} to return the sum of the mock function\textquotesingle{}s argument \#0 and \#1.    \\\cline{1-2}
