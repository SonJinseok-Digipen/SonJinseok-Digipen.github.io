\hypertarget{urlapi-int_8h_source}{}\doxysection{urlapi-\/int.h}
\label{urlapi-int_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/urlapi-\/int.h@{AseSprite/aseprite/third\_party/curl/lib/urlapi-\/int.h}}
...
\DoxyCodeLine{00025\ \textcolor{comment}{/*\ scheme\ is\ not\ URL\ encoded,\ the\ longest\ libcurl\ supported\ ones\ are...\ */}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#define\ MAX\_SCHEME\_LEN\ 40}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{keywordtype}{bool}\ Curl\_is\_absolute\_url(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *url,\ \textcolor{keywordtype}{char}\ *scheme,\ \textcolor{keywordtype}{size\_t}\ buflen);}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{preprocessor}{\#ifdef\ DEBUGBUILD}}
\DoxyCodeLine{00031\ CURLUcode\ Curl\_parse\_port(\textcolor{keyword}{struct}\ \mbox{\hyperlink{struct_curl___u_r_l}{Curl\_URL}}\ *u,\ \textcolor{keywordtype}{char}\ *\mbox{\hyperlink{structhostname}{hostname}},\ \textcolor{keywordtype}{bool});}
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_URLAPI\_INT\_H\ */}\textcolor{preprocessor}{}}
