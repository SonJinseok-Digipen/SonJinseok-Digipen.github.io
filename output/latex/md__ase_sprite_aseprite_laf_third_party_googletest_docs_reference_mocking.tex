This page lists the facilities provided by Google\+Test for creating and working with mock objects. To use them, include the header {\ttfamily gmock/gmock.\+h}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_macros}{}\doxysection{Macros}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_macros}
Google\+Test defines the following macros for working with mocks.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_MOCK_METHOD}{}\doxysubsection{MOCK\+\_\+\+METHOD}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_MOCK_METHOD}
...
{\ttfamily MOCK\+\_\+\+METHOD} must be used in the {\ttfamily public\+:} section of a mock class definition, regardless of whether the method being mocked is {\ttfamily public}, {\ttfamily protected}, or {\ttfamily private} in the base class.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_EXPECT_CALL}{}\doxysubsection{EXPECT\+\_\+\+CALL}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_EXPECT_CALL}
...
See details for each modifier clause below.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md362}{}\doxysubsubsection{With \{\#\+EXPECT\+\_\+\+CALL.\+With\}}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md362}
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md363}{}\doxysubsubsection{Times \{\#\+EXPECT\+\_\+\+CALL.\+Times\}}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md363}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md364}{}\doxysubsubsection{In\+Sequence \{\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md364}
{\ttfamily .In\+Sequence(}$\ast${\ttfamily sequences...}$\ast${\ttfamily )}

Specifies that the mock function call is expected in a certain sequence.

The parameter $\ast${\ttfamily sequences...}$\ast$ is any number of \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_Sequence}{\`{}\+Sequence\`{}}} objects. Expected calls assigned to the same sequence are expected to occur in the order the expectations are declared.
...
See also the \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_InSequence}{\`{}\+In\+Sequence\`{} class}}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md365}{}\doxysubsubsection{After \{\#\+EXPECT\+\_\+\+CALL.\+After\}}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md365}
...
The parameter $\ast${\ttfamily expectations...}$\ast$ can be up to five \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_Expectation}{\`{}\+Expectation\`{}}} or \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_ExpectationSet}{\`{}\+Expectation\+Set\`{}}} objects. The mock function call is expected to occur after all of the given expectations.
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md366}{}\doxysubsubsection{Will\+Once \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md366}
...
The parameter $\ast${\ttfamily action}$\ast$ represents the \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ action}} that the function call will perform. See the \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_actions}{Actions Reference}} for a list of built-\/in actions.
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md367}{}\doxysubsubsection{Will\+Repeatedly \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md367}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md368}{}\doxysubsubsection{Retires\+On\+Saturation \{\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md368}
...
In the above example, the first two calls to {\ttfamily my\+\_\+mock.\+Set\+Number(7)} match expectation 2, which then becomes inactive and no longer matches any calls. \mbox{\hyperlink{class_a}{A}} third call to {\ttfamily my\+\_\+mock.\+Set\+Number(7)} would then match expectation 1. Without {\ttfamily Retires\+On\+Saturation()} on expectation 2, a third call to {\ttfamily my\+\_\+mock.\+Set\+Number(7)} would match expectation 2 again, producing a failure since the limit of 2 calls was exceeded.

The {\ttfamily Retires\+On\+Saturation} clause can be used at most once on an expectation and must be the last clause.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_ON_CALL}{}\doxysubsection{ON\+\_\+\+CALL}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_ON_CALL}
...
The parameter $\ast${\ttfamily matchers...}$\ast$ is a comma-\/separated list of \href{../gmock_for_dummies.md\#matchers-what-arguments-do-we-expect}{\texttt{ matchers}} that correspond to each argument of the method $\ast${\ttfamily method\+\_\+name}$\ast$. The {\ttfamily ON\+\_\+\+CALL} specification will apply only to calls of $\ast${\ttfamily method\+\_\+name}$\ast$ whose arguments match all of the matchers. If {\ttfamily (}$\ast${\ttfamily matchers...}$\ast${\ttfamily )} is omitted, the behavior is as if each argument\textquotesingle{}s matcher were a \href{matchers.md\#wildcard}{\texttt{ wildcard matcher ({\ttfamily \+\_\+})}}. See the \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_matchers}{Matchers Reference}} for a list of all built-\/in matchers.
...
See details for each modifier clause below.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md369}{}\doxysubsubsection{With \{\#\+ON\+\_\+\+CALL.\+With\}}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md369}
{\ttfamily .With(}$\ast${\ttfamily multi\+\_\+argument\+\_\+matcher}$\ast${\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md370}{}\doxysubsubsection{Will\+By\+Default \{\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_autotoc_md370}
...
The {\ttfamily Will\+By\+Default} clause must be used exactly once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_classes}{}\doxysection{Classes}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_classes}
Google\+Test defines the following classes for working with mocks.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_DefaultValue}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_DefaultValue}
...
\DoxyCodeLine{DefaultValue<T>::Set(\mbox{\hyperlink{classvalue}{value}});}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_NiceMock}{}\doxysubsection{Nice\+Mock}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_NiceMock}
...
\DoxyCodeLine{...\ \mbox{\hyperlink{structcode}{code}}\ that\ uses\ my\_mock\ ...}
...
{\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_NaggyMock}{}\doxysubsection{Naggy\+Mock}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_NaggyMock}
...
\mbox{\hyperlink{class_mock}{Mock}} objects of type {\ttfamily T} by default behave the same way as {\ttfamily Naggy\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_StrictMock}{}\doxysubsection{Strict\+Mock}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_StrictMock}
...
{\ttfamily Strict\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_Sequence}{}\doxysubsection{Sequence}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_Sequence}
{\ttfamily \+::testing\+::\+Sequence}

Represents a chronological sequence of expectations. See the \`{}\+In\+Sequence\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL} for usage.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_InSequence}{}\doxysubsection{In\+Sequence}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_InSequence}
...
The name of the {\ttfamily In\+Sequence} object does not matter.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_Expectation}{}\doxysubsection{Expectation}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_Expectation}
{\ttfamily \+::testing\+::\+Expectation}

Represents a mock function call expectation as created by \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_EXPECT_CALL}{\`{}\+EXPECT\+\_\+\+CALL\`{}}}\+:
...
Useful for specifying sequences of expectations; see the \`{}\+After\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_ExpectationSet}{}\doxysubsection{Expectation\+Set}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_ExpectationSet}
{\ttfamily \+::testing\+::\+Expectation\+Set}

Represents a set of mock function call expectations.

Use the {\ttfamily +=} operator to add \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_mocking_Expectation}{\`{}\+Expectation\`{}}} objects to the set\+:
