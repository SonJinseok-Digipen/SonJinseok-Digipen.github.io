\hypertarget{_tengu_2bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2logger_8h_source}{}\doxysection{logger.\+h}
\label{_tengu_2bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2logger_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/logger.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/logger.h}}
...
\DoxyCodeLine{00053\ }
\DoxyCodeLine{00054\ \textcolor{keyword}{class\ }SPDLOG\_API\ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}}
\DoxyCodeLine{00055\ \{}
\DoxyCodeLine{00056\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00057\ \ \ \ \ \textcolor{comment}{//\ Empty\ logger}}
\DoxyCodeLine{00058\ \ \ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}(std::string\ name)}
...
\DoxyCodeLine{00065\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}(std::string\ name,\ It\ begin,\ It\ end)}
...
\DoxyCodeLine{00071\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}(std::string\ name,\ sink\_ptr\ single\_sink)}
\DoxyCodeLine{00072\ \ \ \ \ \ \ \ \ :\ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}(std::move(name),\ \{std::move(single\_sink)\})}
\DoxyCodeLine{00073\ \ \ \ \ \{\}}
\DoxyCodeLine{00074\ }
\DoxyCodeLine{00075\ \ \ \ \ \textcolor{comment}{//\ Logger\ with\ sinks\ init\ list}}
\DoxyCodeLine{00076\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}(std::string\ name,\ sinks\_init\_list\ sinks)}
\DoxyCodeLine{00077\ \ \ \ \ \ \ \ \ :\ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}(std::move(name),\ sinks.begin(),\ sinks.end())}
\DoxyCodeLine{00078\ \ \ \ \ \{\}}
\DoxyCodeLine{00079\ }
\DoxyCodeLine{00080\ \ \ \ \ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{classspdlog_1_1logger}{\string~logger}}()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00081\ }
\DoxyCodeLine{00082\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}\ \&other);}
\DoxyCodeLine{00083\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}(\mbox{\hyperlink{classspdlog_1_1logger}{logger}}\ \&\&other)\ SPDLOG\_NOEXCEPT;}
\DoxyCodeLine{00084\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}\ \&operator=(\mbox{\hyperlink{classspdlog_1_1logger}{logger}}\ other)\ SPDLOG\_NOEXCEPT;}
...
\DoxyCodeLine{00088\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{structlog}{log}}(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\ loc,\ level::level\_enum\ lvl,\ format\_string\_t<Args...>\ fmt,\ Args\ \&\&...\ args)}
\DoxyCodeLine{00089\ \ \ \ \ \{}
...
\DoxyCodeLine{00095\ \ \ \ \ \{}
\DoxyCodeLine{00096\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structlog}{log}}(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\{\},\ lvl,\ fmt,\ std::forward<Args>(args)...);}
\DoxyCodeLine{00097\ \ \ \ \ \}}
\DoxyCodeLine{00098\ }
...
\DoxyCodeLine{00101\ \ \ \ \ \{}
\DoxyCodeLine{00102\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structlog}{log}}(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\{\},\ lvl,\ msg);}
\DoxyCodeLine{00103\ \ \ \ \ \}}
\DoxyCodeLine{00104\ }
...
\DoxyCodeLine{00107\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{structlog}{log}}(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\ loc,\ level::level\_enum\ lvl,\ \textcolor{keyword}{const}\ T\ \&msg)}
\DoxyCodeLine{00108\ \ \ \ \ \{}
\DoxyCodeLine{00109\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structlog}{log}}(loc,\ lvl,\ \textcolor{stringliteral}{"{}\{\}"{}},\ msg);}
\DoxyCodeLine{00110\ \ \ \ \ \}}
\DoxyCodeLine{00111\ }
\DoxyCodeLine{00112\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{structlog}{log}}(log\_clock::time\_point\ log\_time,\ \mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\ loc,\ level::level\_enum\ lvl,\ string\_view\_t\ msg)}
\DoxyCodeLine{00113\ \ \ \ \ \{}
...
\DoxyCodeLine{00119\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00120\ }
\DoxyCodeLine{00121\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ log\_msg(log\_time,\ loc,\ name\_,\ lvl,\ msg);}
\DoxyCodeLine{00122\ \ \ \ \ \ \ \ \ log\_it\_(log\_msg,\ log\_enabled,\ traceback\_enabled);}
\DoxyCodeLine{00123\ \ \ \ \ \}}
\DoxyCodeLine{00124\ }
\DoxyCodeLine{00125\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{structlog}{log}}(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\ loc,\ level::level\_enum\ lvl,\ string\_view\_t\ msg)}
\DoxyCodeLine{00126\ \ \ \ \ \{}
...
\DoxyCodeLine{00132\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00133\ }
\DoxyCodeLine{00134\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ log\_msg(loc,\ name\_,\ lvl,\ msg);}
...
\DoxyCodeLine{00139\ \ \ \ \ \{}
\DoxyCodeLine{00140\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structlog}{log}}(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\{\},\ lvl,\ msg);}
\DoxyCodeLine{00141\ \ \ \ \ \}}
\DoxyCodeLine{00142\ }
...
\DoxyCodeLine{00181\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{structlog}{log}}(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\ loc,\ level::level\_enum\ lvl,\ wformat\_string\_t<Args...>\ fmt,\ Args\ \&\&...\ args)}
\DoxyCodeLine{00182\ \ \ \ \ \{}
...
\DoxyCodeLine{00188\ \ \ \ \ \{}
\DoxyCodeLine{00189\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structlog}{log}}(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\{\},\ lvl,\ fmt,\ std::forward<Args>(args)...);}
\DoxyCodeLine{00190\ \ \ \ \ \}}
\DoxyCodeLine{00191\ }
\DoxyCodeLine{00192\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{structlog}{log}}(log\_clock::time\_point\ log\_time,\ \mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\ loc,\ level::level\_enum\ lvl,\ wstring\_view\_t\ msg)}
\DoxyCodeLine{00193\ \ \ \ \ \{}
...
\DoxyCodeLine{00203\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ log\_msg(log\_time,\ loc,\ name\_,\ lvl,\ string\_view\_t(\mbox{\hyperlink{structbuf}{buf}}.data(),\ \mbox{\hyperlink{structbuf}{buf}}.size()));}
\DoxyCodeLine{00204\ \ \ \ \ \ \ \ \ log\_it\_(log\_msg,\ log\_enabled,\ traceback\_enabled);}
\DoxyCodeLine{00205\ \ \ \ \ \}}
\DoxyCodeLine{00206\ }
\DoxyCodeLine{00207\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{structlog}{log}}(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\ loc,\ level::level\_enum\ lvl,\ wstring\_view\_t\ msg)}
\DoxyCodeLine{00208\ \ \ \ \ \{}
...
\DoxyCodeLine{00218\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ log\_msg(loc,\ name\_,\ lvl,\ string\_view\_t(\mbox{\hyperlink{structbuf}{buf}}.data(),\ \mbox{\hyperlink{structbuf}{buf}}.size()));}
...
\DoxyCodeLine{00223\ \ \ \ \ \{}
\DoxyCodeLine{00224\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structlog}{log}}(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\{\},\ lvl,\ msg);}
\DoxyCodeLine{00225\ \ \ \ \ \}}
\DoxyCodeLine{00226\ }
...
\DoxyCodeLine{00356\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1details_1_1backtracer}{details::backtracer}}\ tracer\_;}
\DoxyCodeLine{00357\ }
...
\DoxyCodeLine{00360\ \ \ \ \ \textcolor{keywordtype}{void}\ log\_(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\ loc,\ level::level\_enum\ lvl,\ string\_view\_t\ fmt,\ Args\ \&\&...\ args)}
\DoxyCodeLine{00361\ \ \ \ \ \{}
...
\DoxyCodeLine{00376\ }
\DoxyCodeLine{00377\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ log\_msg(loc,\ name\_,\ lvl,\ string\_view\_t(\mbox{\hyperlink{structbuf}{buf}}.data(),\ \mbox{\hyperlink{structbuf}{buf}}.size()));}
...
\DoxyCodeLine{00385\ \ \ \ \ \textcolor{keywordtype}{void}\ log\_(\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}\ loc,\ level::level\_enum\ lvl,\ wstring\_view\_t\ fmt,\ Args\ \&\&...\ args)}
\DoxyCodeLine{00386\ \ \ \ \ \{}
...
\DoxyCodeLine{00402\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ log\_msg(loc,\ name\_,\ lvl,\ string\_view\_t(\mbox{\hyperlink{structbuf}{buf}}.data(),\ \mbox{\hyperlink{structbuf}{buf}}.size()));}
...
\DoxyCodeLine{00411\ \ \ \ \ \textcolor{keywordtype}{void}\ log\_it\_(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&log\_msg,\ \textcolor{keywordtype}{bool}\ log\_enabled,\ \textcolor{keywordtype}{bool}\ traceback\_enabled);}
\DoxyCodeLine{00412\ \ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&msg);}
...
\DoxyCodeLine{00415\ \ \ \ \ \textcolor{keywordtype}{bool}\ should\_flush\_(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&msg);}
\DoxyCodeLine{00416\ }
...
\DoxyCodeLine{00420\ \};}
\DoxyCodeLine{00421\ }
\DoxyCodeLine{00422\ \textcolor{keywordtype}{void}\ swap(\mbox{\hyperlink{classspdlog_1_1logger}{logger}}\ \&\mbox{\hyperlink{structa}{a}},\ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}\ \&b);}
\DoxyCodeLine{00423\ }
