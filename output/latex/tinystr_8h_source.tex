...
\label{tinystr_8h_source}\index{AseSprite/aseprite/third\_party/tinyxml/tinystr.h@{AseSprite/aseprite/third\_party/tinyxml/tinystr.h}}
...
\DoxyCodeLine{00131\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ \mbox{\hyperlink{structdata}{data}}\ ()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ rep\_-\/>str;\ \}}
\DoxyCodeLine{00132\ }
...
\DoxyCodeLine{00253\ }
\DoxyCodeLine{00254\ }
\DoxyCodeLine{00255\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ ==\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)}
\DoxyCodeLine{00256\ \{}
\DoxyCodeLine{00257\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \ \ \ (\ \mbox{\hyperlink{structa}{a}}.length()\ ==\ b.length()\ )\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ optimization\ on\ some\ platforms}}
\DoxyCodeLine{00258\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \&\&\ (\ strcmp(\mbox{\hyperlink{structa}{a}}.c\_str(),\ b.c\_str())\ ==\ 0\ );\ \ \ \ \ \ \ \ \textcolor{comment}{//\ actual\ compare}}
\DoxyCodeLine{00259\ \}}
\DoxyCodeLine{00260\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ <\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)}
\DoxyCodeLine{00261\ \{}
\DoxyCodeLine{00262\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ strcmp(\mbox{\hyperlink{structa}{a}}.c\_str(),\ b.c\_str())\ <\ 0;}
\DoxyCodeLine{00263\ \}}
\DoxyCodeLine{00264\ }
\DoxyCodeLine{00265\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ !=\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(\mbox{\hyperlink{structa}{a}}\ ==\ b);\ \}}
\DoxyCodeLine{00266\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ >\ \ (\textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ b\ <\ \mbox{\hyperlink{structa}{a}};\ \}}
\DoxyCodeLine{00267\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ <=\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(b\ <\ \mbox{\hyperlink{structa}{a}});\ \}}
\DoxyCodeLine{00268\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ >=\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(\mbox{\hyperlink{structa}{a}}\ <\ b);\ \}}
\DoxyCodeLine{00269\ }
\DoxyCodeLine{00270\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ ==\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ b)\ \{\ \textcolor{keywordflow}{return}\ strcmp(\mbox{\hyperlink{structa}{a}}.c\_str(),\ b)\ ==\ 0;\ \}}
\DoxyCodeLine{00271\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ ==\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ b\ ==\ \mbox{\hyperlink{structa}{a}};\ \}}
\DoxyCodeLine{00272\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ !=\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ b)\ \{\ \textcolor{keywordflow}{return}\ !(\mbox{\hyperlink{structa}{a}}\ ==\ b);\ \}}
\DoxyCodeLine{00273\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ !=\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(b\ ==\ \mbox{\hyperlink{structa}{a}});\ \}}
\DoxyCodeLine{00274\ }
\DoxyCodeLine{00275\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ operator\ +\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b);}
\DoxyCodeLine{00276\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ operator\ +\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ b);}
\DoxyCodeLine{00277\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ operator\ +\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \mbox{\hyperlink{structa}{a}},\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b);}
\DoxyCodeLine{00278\ }
\DoxyCodeLine{00279\ }
