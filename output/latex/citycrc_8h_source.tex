...
\label{citycrc_8h_source}\index{AseSprite/aseprite/third\_party/cityhash/src/citycrc.h@{AseSprite/aseprite/third\_party/cityhash/src/citycrc.h}}
...
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#include\ <city.h>}}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{comment}{//\ Hash\ function\ for\ a\ byte\ array.}}
\DoxyCodeLine{00034\ uint128\ CityHashCrc128(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *s,\ \textcolor{keywordtype}{size\_t}\ len);}
\DoxyCodeLine{00035\ }
...
\DoxyCodeLine{00038\ uint128\ CityHashCrc128WithSeed(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *s,\ \textcolor{keywordtype}{size\_t}\ len,\ uint128\ seed);}
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \textcolor{comment}{//\ Hash\ function\ for\ a\ byte\ array.\ \ Sets\ result[0]\ ...\ result[3].}}
\DoxyCodeLine{00041\ \textcolor{keywordtype}{void}\ CityHashCrc256(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *s,\ \textcolor{keywordtype}{size\_t}\ len,\ uint64\ *result);}
\DoxyCodeLine{00042\ }
