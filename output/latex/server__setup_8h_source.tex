\hypertarget{server__setup_8h_source}{}\doxysection{server\+\_\+setup.\+h}
\label{server__setup_8h_source}\index{AseSprite/aseprite/third\_party/curl/tests/server/server\_setup.h@{AseSprite/aseprite/third\_party/curl/tests/server/server\_setup.h}}

\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{preprocessor}{\#ifndef\ HEADER\_CURL\_SERVER\_SETUP\_H}}
\DoxyCodeLine{00002\ \textcolor{preprocessor}{\#define\ HEADER\_CURL\_SERVER\_SETUP\_H}}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#include\ "{}curl\_setup.h"{}}\ \textcolor{comment}{/*\ portability\ help\ from\ the\ lib\ directory\ */}}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_SERVER\_SETUP\_H\ */}\textcolor{preprocessor}{}}
