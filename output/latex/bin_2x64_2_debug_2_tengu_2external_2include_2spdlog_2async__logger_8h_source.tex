\hypertarget{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2async__logger_8h_source}{}\doxysection{async\+\_\+logger.\+h}
\label{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2async__logger_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/async\_logger.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/async\_logger.h}}
...
\DoxyCodeLine{00031\ \}}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{keyword}{class\ }SPDLOG\_API\ \mbox{\hyperlink{classspdlog_1_1async__logger}{async\_logger}}\ final\ :\ \textcolor{keyword}{public}\ std::enable\_shared\_from\_this<async\_logger>,\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}}
\DoxyCodeLine{00034\ \{}
...
\DoxyCodeLine{00039\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1async__logger}{async\_logger}}(std::string\ logger\_name,\ It\ begin,\ It\ end,\ std::weak\_ptr<details::thread\_pool>\ tp,}
\DoxyCodeLine{00040\ \ \ \ \ \ \ \ \ async\_overflow\_policy\ overflow\_policy\ =\ async\_overflow\_policy::block)}
\DoxyCodeLine{00041\ \ \ \ \ \ \ \ \ :\ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}(std::move(logger\_name),\ begin,\ end)}
\DoxyCodeLine{00042\ \ \ \ \ \ \ \ \ ,\ thread\_pool\_(std::move(tp))}
\DoxyCodeLine{00043\ \ \ \ \ \ \ \ \ ,\ overflow\_policy\_(overflow\_policy)}
\DoxyCodeLine{00044\ \ \ \ \ \{\}}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00046\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1async__logger}{async\_logger}}(std::string\ logger\_name,\ sinks\_init\_list\ sinks\_list,\ std::weak\_ptr<details::thread\_pool>\ tp,}
\DoxyCodeLine{00047\ \ \ \ \ \ \ \ \ async\_overflow\_policy\ overflow\_policy\ =\ async\_overflow\_policy::block);}
\DoxyCodeLine{00048\ }
\DoxyCodeLine{00049\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1async__logger}{async\_logger}}(std::string\ logger\_name,\ sink\_ptr\ single\_sink,\ std::weak\_ptr<details::thread\_pool>\ tp,}
...
\DoxyCodeLine{00055\ \ \ \ \ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&msg)\ \textcolor{keyword}{override};}
\DoxyCodeLine{00056\ \ \ \ \ \textcolor{keywordtype}{void}\ flush\_()\ \textcolor{keyword}{override};}
\DoxyCodeLine{00057\ \ \ \ \ \textcolor{keywordtype}{void}\ backend\_sink\_it\_(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&incoming\_log\_msg);}
