\hypertarget{server__sockaddr_8h_source}{}\doxysection{server\+\_\+sockaddr.\+h}
\label{server__sockaddr_8h_source}\index{AseSprite/aseprite/third\_party/curl/tests/server/server\_sockaddr.h@{AseSprite/aseprite/third\_party/curl/tests/server/server\_sockaddr.h}}

\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{preprocessor}{\#ifndef\ HEADER\_CURL\_SERVER\_SOCKADDR\_H}}
\DoxyCodeLine{00002\ \textcolor{preprocessor}{\#define\ HEADER\_CURL\_SERVER\_SOCKADDR\_H}}
...
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#ifdef\ HAVE\_SYS\_UN\_H}}
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#include\ <sys/un.h>}\ \textcolor{comment}{/*\ for\ sockaddr\_un\ */}}
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{keyword}{typedef}\ \textcolor{keyword}{union\ }\{}
\DoxyCodeLine{00031\ \ \ \textcolor{keyword}{struct\ }sockaddr\ \ \ \ \ \ sa;}
\DoxyCodeLine{00032\ \ \ \textcolor{keyword}{struct\ }sockaddr\_in\ \ \ sa4;}
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#ifdef\ ENABLE\_IPV6}}
\DoxyCodeLine{00034\ \ \ \textcolor{keyword}{struct\ }sockaddr\_in6\ \ sa6;}
\DoxyCodeLine{00035\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00036\ \textcolor{preprocessor}{\#ifdef\ USE\_UNIX\_SOCKETS}}
\DoxyCodeLine{00037\ \ \ \textcolor{keyword}{struct\ }sockaddr\_un\ \ \ sau;}
\DoxyCodeLine{00038\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00039\ \}\ \mbox{\hyperlink{unionsrvr__sockaddr__union__t}{srvr\_sockaddr\_union\_t}};}
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_SERVER\_SOCKADDR\_H\ */}\textcolor{preprocessor}{}}
