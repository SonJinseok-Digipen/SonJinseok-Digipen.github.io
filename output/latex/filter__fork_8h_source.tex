\hypertarget{filter__fork_8h_source}{}\doxysection{filter\+\_\+fork.\+h}
\label{filter__fork_8h_source}\index{AseSprite/aseprite/third\_party/libarchive/libarchive/filter\_fork.h@{AseSprite/aseprite/third\_party/libarchive/libarchive/filter\_fork.h}}

\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{comment}{/*-\/}}
\DoxyCodeLine{00002\ \textcolor{comment}{\ *\ Copyright\ (c)\ 2007\ Joerg\ Sonnenberger}}
...
\DoxyCodeLine{00025\ \textcolor{comment}{\ *\ \$FreeBSD:\ head/lib/libarchive/filter\_fork.h\ 201087\ 2009-\/12-\/28\ 02:18:26Z\ kientzle\ \$}}
\DoxyCodeLine{00026\ \textcolor{comment}{\ */}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#ifndef\ FILTER\_FORK\_H}}
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#define\ FILTER\_FORK\_H}}
\DoxyCodeLine{00030\ }
...
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \textcolor{keywordtype}{int}}
\DoxyCodeLine{00036\ \_\_archive\_create\_child(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *cmd,\ \textcolor{keywordtype}{int}\ *child\_stdin,\ \textcolor{keywordtype}{int}\ *child\_stdout,}
\DoxyCodeLine{00037\ \#\textcolor{keywordflow}{if}\ defined(\_WIN32)\ \&\&\ !defined(\_\_CYGWIN\_\_)}
\DoxyCodeLine{00038\ \ \ \ \ HANDLE\ *out\_child);}
\DoxyCodeLine{00039\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00040\ \ \ \ \ pid\_t\ *out\_child);}
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \textcolor{keywordtype}{void}}
\DoxyCodeLine{00044\ \_\_archive\_check\_child(\textcolor{keywordtype}{int}\ in,\ \textcolor{keywordtype}{int}\ out);}
\DoxyCodeLine{00045\ }
