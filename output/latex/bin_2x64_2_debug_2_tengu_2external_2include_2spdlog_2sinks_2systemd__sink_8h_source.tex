\hypertarget{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2systemd__sink_8h_source}{}\doxysection{systemd\+\_\+sink.\+h}
\label{bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2sinks_2systemd__sink_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/systemd\_sink.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/sinks/systemd\_sink.h}}
...
\DoxyCodeLine{00023\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1systemd__sink}{systemd\_sink}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink}}<Mutex>}
\DoxyCodeLine{00024\ \{}
\DoxyCodeLine{00025\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00026\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1systemd__sink}{systemd\_sink}}(std::string\ ident\ =\ \textcolor{stringliteral}{"{}"{}},\ \textcolor{keywordtype}{bool}\ enable\_formatting\ =\ \textcolor{keyword}{false})}
...
\DoxyCodeLine{00036\ \ \ \ \ \{\}}
\DoxyCodeLine{00037\ }
\DoxyCodeLine{00038\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1systemd__sink}{\string~systemd\_sink}}()\textcolor{keyword}{\ override\ }\{\}}
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1systemd__sink}{systemd\_sink}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1systemd__sink}{systemd\_sink}}\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00041\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1systemd__sink}{systemd\_sink}}\ \&operator=(\textcolor{keyword}{const}\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1systemd__sink}{systemd\_sink}}\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00042\ }
...
\DoxyCodeLine{00048\ }
\DoxyCodeLine{00049\ \ \ \ \ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&msg)\textcolor{keyword}{\ override}}
...
\DoxyCodeLine{00055\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00056\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink<Mutex>::formatter\_}}-\/>format(msg,\ formatted);}
...
\DoxyCodeLine{00099\ \};}
\DoxyCodeLine{00100\ }
\DoxyCodeLine{00101\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1systemd__sink}{systemd\_sink\_mt}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1systemd__sink}{systemd\_sink<std::mutex>}};}
\DoxyCodeLine{00102\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1systemd__sink}{systemd\_sink\_st}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1systemd__sink}{systemd\_sink<details::null\_mutex>}};}
