...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily samples/sample3\+\_\+unittest.\+cc}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_pkgconfig_autotoc_md316}{}\doxysubsection{CMake}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_pkgconfig_autotoc_md316}
...
pkg-\/config will also try to look in {\ttfamily PKG\+\_\+\+CONFIG\+\_\+\+PATH} to find {\ttfamily gtest\+\_\+main.\+pc}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_pkgconfig_autotoc_md318}{}\doxysubsection{Using pkg-\/config in a cross-\/compilation setting}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_pkgconfig_autotoc_md318}
