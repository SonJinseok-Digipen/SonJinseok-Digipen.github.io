\hypertarget{sectransp_8h_source}{}\doxysection{sectransp.\+h}
\label{sectransp_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/vtls/sectransp.h@{AseSprite/aseprite/third\_party/curl/lib/vtls/sectransp.h}}
...
\DoxyCodeLine{00010\ \textcolor{comment}{\ *\ Copyright\ (C)\ 2012\ -\/\ 2014,\ Nick\ Zitzmann,\ <nickzman@gmail.com>.}}
\DoxyCodeLine{00011\ \textcolor{comment}{\ *\ Copyright\ (C)\ 2012\ -\/\ 2020,\ Daniel\ Stenberg,\ <daniel@haxx.se>,\ et\ al.}}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#ifdef\ USE\_SECTRANSP}}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{keyword}{extern}\ \textcolor{keyword}{const}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{struct_curl__ssl}{Curl\_ssl}}\ Curl\_ssl\_sectransp;}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ USE\_SECTRANSP\ */}\textcolor{preprocessor}{}}
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_SECTRANSP\_H\ */}\textcolor{preprocessor}{}}
