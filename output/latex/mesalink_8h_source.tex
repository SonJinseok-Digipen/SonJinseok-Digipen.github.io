\hypertarget{mesalink_8h_source}{}\doxysection{mesalink.\+h}
\label{mesalink_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/vtls/mesalink.h@{AseSprite/aseprite/third\_party/curl/lib/vtls/mesalink.h}}

\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{preprocessor}{\#ifndef\ HEADER\_CURL\_MESALINK\_H}}
\DoxyCodeLine{00002\ \textcolor{preprocessor}{\#define\ HEADER\_CURL\_MESALINK\_H}}
...
\DoxyCodeLine{00010\ \textcolor{comment}{\ *\ Copyright\ (C)\ 2017\ -\/\ 2018,\ Yiming\ Jing,\ <jingyiming@baidu.com>}}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#ifdef\ USE\_MESALINK}}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{keyword}{extern}\ \textcolor{keyword}{const}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{struct_curl__ssl}{Curl\_ssl}}\ Curl\_ssl\_mesalink;}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ USE\_MESALINK\ */}\textcolor{preprocessor}{}}
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_MESALINK\_H\ */}\textcolor{preprocessor}{}}
