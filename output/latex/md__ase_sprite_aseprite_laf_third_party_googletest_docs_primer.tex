\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md324}{}\doxysection{Introduction\+: Why googletest?}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md324}
...
Since googletest is based on the popular x\+Unit architecture, you\textquotesingle{}ll feel right at home if you\textquotesingle{}ve used JUnit or Py\+Unit before. If not, it will take you about 10 minutes to learn the basics and get started. So let\textquotesingle{}s go!\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md325}{}\doxysection{Beware of the nomenclature}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md325}
\{\+: .callout .note\} {\itshape Note\+:} There might be some confusion arising from different definitions of the terms {\itshape \mbox{\hyperlink{class_test}{Test}}}, {\itshape \mbox{\hyperlink{class_test}{Test}} Case} and {\itshape \mbox{\hyperlink{class_test}{Test}} Suite}, so beware of misunderstanding these.

Historically, googletest started to use the term {\itshape \mbox{\hyperlink{class_test}{Test}} Case} for grouping related tests, whereas current publications, including International Software Testing Qualifications Board (\href{http://www.istqb.org/}{\texttt{ ISTQB}}) materials and various textbooks on software quality, use the term {\itshape \href{http://glossary.istqb.org/en/search/test\%20suite}{\texttt{ Test Suite}}} for this.

The related term {\itshape \mbox{\hyperlink{class_test}{Test}}}, as it is used in googletest, corresponds to the term {\itshape \href{http://glossary.istqb.org/en/search/test\%20case}{\texttt{ Test Case}}} of ISTQB and others.

The term {\itshape \mbox{\hyperlink{class_test}{Test}}} is commonly of broad enough sense, including ISTQB\textquotesingle{}s definition of {\itshape \mbox{\hyperlink{class_test}{Test}} Case}, so it\textquotesingle{}s not much of a problem here. But the term {\itshape \mbox{\hyperlink{class_test}{Test}} Case} as was used in Google \mbox{\hyperlink{class_test}{Test}} is of contradictory sense and thus confusing.

googletest recently started replacing the term {\itshape \mbox{\hyperlink{class_test}{Test}} Case} with {\itshape \mbox{\hyperlink{class_test}{Test}} Suite}. The preferred API is {\itshape Test\+Suite}. The older \mbox{\hyperlink{struct_test_case}{Test\+Case}} API is being slowly deprecated and refactored away.
...
\end{longtabu}
\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md326}{}\doxysection{Basic Concepts}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md326}
...
\mbox{\hyperlink{class_a}{A}} {\itshape test suite} contains one or many tests. You should group your tests into test suites that reflect the structure of the tested code. When multiple tests in a test suite need to share common objects and subroutines, you can put them into a {\itshape test fixture} class.

\mbox{\hyperlink{class_a}{A}} {\itshape test program} can contain multiple test suites.

We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md327}{}\doxysection{Assertions}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md327}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \mbox{\hyperlink{md__ase_sprite_aseprite_laf_third_party_googletest_docs_reference_assertions}{Assertions Reference}}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md328}{}\doxysection{Simple Tests}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md328}
To create a test\+:
...
{\ttfamily TEST()} arguments go from general to specific. The {\itshape first} argument is the name of the test suite, and the {\itshape second} argument is the test\textquotesingle{}s name within the test suite. Both names must be valid C++ identifiers, and they should not contain any underscores ({\ttfamily \+\_\+}). \mbox{\hyperlink{class_a}{A}} test\textquotesingle{}s {\itshape full name} consists of its containing test suite and its individual name. Tests from different test suites can have the same individual name.
...
\mbox{\hyperlink{class_a}{A}} test suite for this function might look like\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_same-data-multiple-tests}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_same-data-multiple-tests}
...
\item If necessary, write a default constructor or {\ttfamily Set\+Up()} function to prepare the objects for each test. \mbox{\hyperlink{class_a}{A}} common mistake is to spell {\ttfamily Set\+Up()} as $\ast$$\ast${\ttfamily Setup()}$\ast$$\ast$ with a small {\ttfamily u} -\/ Use {\ttfamily override} in C++11 to make sure you spelled it correctly.
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md329}{}\doxysection{Invoking the Tests}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md329}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md330}{}\doxysection{Writing the main() Function}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md330}
...
But maybe you think that writing all those {\ttfamily main} functions is too much work? We agree with you completely, and that\textquotesingle{}s why Google \mbox{\hyperlink{class_test}{Test}} provides a basic implementation of main(). If it fits your needs, then just link your test with the {\ttfamily gtest\+\_\+main} library and you are good to go.

\{\+: .callout .note\} NOTE\+: {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md331}{}\doxysection{Known Limitations}\label{md__ase_sprite_aseprite_laf_third_party_googletest_docs_primer_autotoc_md331}

\begin{DoxyItemize}
\item Google \mbox{\hyperlink{class_test}{Test}} is designed to be thread-\/safe. The implementation is thread-\/safe on systems where the {\ttfamily pthreads} library is available. It is currently {\itshape unsafe} to use Google \mbox{\hyperlink{class_test}{Test}} assertions from two threads concurrently on other systems (e.\+g. Windows). In most tests this is not an issue as usually the assertions are done in the main thread. If you want to help, you can volunteer to implement the necessary synchronization primitives in {\ttfamily gtest-\/port.\+h} for your platform. 
\end{DoxyItemize}