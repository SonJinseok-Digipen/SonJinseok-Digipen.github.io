\hypertarget{_tengu_2bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2common_8h_source}{}\doxysection{common.\+h}
\label{_tengu_2bin_2x64_2_debug_2_tengu_2external_2include_2spdlog_2common_8h_source}\index{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/common.h@{Tengu/bin/x64/Debug/Tengu/external/include/spdlog/common.h}}
...
\DoxyCodeLine{00179\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structspdlog_1_1is__convertible__to__basic__format__string}{is\_convertible\_to\_basic\_format\_string}}}
...
\DoxyCodeLine{00201\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structspdlog_1_1is__convertible__to__any__format__string}{is\_convertible\_to\_any\_format\_string}}\ :\ std::integral\_constant<bool,\ is\_convertible\_to\_basic\_format\_string<T,\ char>::value\ ||}
...
\DoxyCodeLine{00206\ \textcolor{keyword}{using\ }level\_t\ =\ \mbox{\hyperlink{structspdlog_1_1details_1_1null__atomic__int}{details::null\_atomic\_int}};}
...
\DoxyCodeLine{00290\ \textcolor{keyword}{class\ }SPDLOG\_API\ \mbox{\hyperlink{classspdlog_1_1spdlog__ex}{spdlog\_ex}}\ :\ \textcolor{keyword}{public}\ std::exception}
\DoxyCodeLine{00291\ \{}
\DoxyCodeLine{00292\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00293\ \ \ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classspdlog_1_1spdlog__ex}{spdlog\_ex}}(std::string\ msg);}
\DoxyCodeLine{00294\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1spdlog__ex}{spdlog\_ex}}(\textcolor{keyword}{const}\ std::string\ \&msg,\ \textcolor{keywordtype}{int}\ last\_errno);}
\DoxyCodeLine{00295\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *what()\ \textcolor{keyword}{const}\ SPDLOG\_NOEXCEPT\ \textcolor{keyword}{override};}
\DoxyCodeLine{00296\ }
\DoxyCodeLine{00297\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00298\ \ \ \ \ std::string\ msg\_;}
\DoxyCodeLine{00299\ \};}
\DoxyCodeLine{00300\ }
\DoxyCodeLine{00301\ [[noreturn]]\ SPDLOG\_API\ \textcolor{keywordtype}{void}\ throw\_spdlog\_ex(\textcolor{keyword}{const}\ std::string\ \&msg,\ \textcolor{keywordtype}{int}\ last\_errno);}
\DoxyCodeLine{00302\ [[noreturn]]\ SPDLOG\_API\ \textcolor{keywordtype}{void}\ throw\_spdlog\_ex(std::string\ msg);}
\DoxyCodeLine{00303\ }
\DoxyCodeLine{00304\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}}
\DoxyCodeLine{00305\ \{}
\DoxyCodeLine{00306\ \ \ \ \ SPDLOG\_CONSTEXPR\ \mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00307\ \ \ \ \ SPDLOG\_CONSTEXPR\ \mbox{\hyperlink{structspdlog_1_1source__loc}{source\_loc}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *filename\_in,\ \textcolor{keywordtype}{int}\ line\_in,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *funcname\_in)}
\DoxyCodeLine{00308\ \ \ \ \ \ \ \ \ :\ filename\{filename\_in\}}
\DoxyCodeLine{00309\ \ \ \ \ \ \ \ \ ,\ line\{line\_in\}}
\DoxyCodeLine{00310\ \ \ \ \ \ \ \ \ ,\ funcname\{funcname\_in\}}
\DoxyCodeLine{00311\ \ \ \ \ \{\}}
\DoxyCodeLine{00312\ }
\DoxyCodeLine{00313\ \ \ \ \ SPDLOG\_CONSTEXPR\ \textcolor{keywordtype}{bool}\ empty()\ \textcolor{keyword}{const}\ SPDLOG\_NOEXCEPT}
\DoxyCodeLine{00314\ \ \ \ \ \{}
...
\DoxyCodeLine{00320\ \};}
\DoxyCodeLine{00321\ }
\DoxyCodeLine{00322\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structspdlog_1_1file__event__handlers}{file\_event\_handlers}}}
\DoxyCodeLine{00323\ \{}
\DoxyCodeLine{00324\ \ \ \ \ \mbox{\hyperlink{structspdlog_1_1file__event__handlers}{file\_event\_handlers}}()}
\DoxyCodeLine{00325\ \ \ \ \ \ \ \ \ :\ before\_open(\textcolor{keyword}{nullptr})}
\DoxyCodeLine{00326\ \ \ \ \ \ \ \ \ ,\ after\_open(\textcolor{keyword}{nullptr})}
\DoxyCodeLine{00327\ \ \ \ \ \ \ \ \ ,\ before\_close(\textcolor{keyword}{nullptr})}
\DoxyCodeLine{00328\ \ \ \ \ \ \ \ \ ,\ after\_close(\textcolor{keyword}{nullptr})}
\DoxyCodeLine{00329\ \ \ \ \ \{\}}
\DoxyCodeLine{00330\ }
