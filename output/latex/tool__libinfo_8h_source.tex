\hypertarget{tool__libinfo_8h_source}{}\doxysection{tool\+\_\+libinfo.\+h}
\label{tool__libinfo_8h_source}\index{AseSprite/aseprite/third\_party/curl/src/tool\_libinfo.h@{AseSprite/aseprite/third\_party/curl/src/tool\_libinfo.h}}
...
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00026\ \textcolor{comment}{/*\ global\ variable\ declarations,\ for\ libcurl\ run-\/time\ info\ */}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{keyword}{extern}\ \mbox{\hyperlink{structcurl__version__info__data}{curl\_version\_info\_data}}\ *curlinfo;}
\DoxyCodeLine{00029\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{long}\ built\_in\_protos;}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ CURLcode\ get\_libcurl\_info(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ HEADER\_CURL\_TOOL\_LIBINFO\_H\ */}\textcolor{preprocessor}{}}
