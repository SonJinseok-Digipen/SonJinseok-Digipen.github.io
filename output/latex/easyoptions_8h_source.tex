\hypertarget{easyoptions_8h_source}{}\doxysection{easyoptions.\+h}
\label{easyoptions_8h_source}\index{AseSprite/aseprite/third\_party/curl/lib/easyoptions.h@{AseSprite/aseprite/third\_party/curl/lib/easyoptions.h}}
...
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{comment}{/*\ should\ probably\ go\ into\ the\ public\ header\ */}}
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#include\ <curl/curl.h>}}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{comment}{/*\ generated\ table\ with\ all\ easy\ options\ */}}
\DoxyCodeLine{00030\ \textcolor{keyword}{extern}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structcurl__easyoption}{curl\_easyoption}}\ Curl\_easyopts[];}
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#ifdef\ DEBUGBUILD}}
\DoxyCodeLine{00033\ \textcolor{keywordtype}{int}\ Curl\_easyopts\_check(\textcolor{keywordtype}{void});}
